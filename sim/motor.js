...
// ---- Feuer ----
const RATE = [F.ZUNDER]; // der letzte Hitze-Verstärker (Rate; Feuersturm ist seit §7.17 Serie zu Score, Glut seit §7.23 gestrichen, Rückzündung seit §7.24 Takt)
const CORE = [F.KLINGE, F.WEISSGLUT, F.VERBRENNUNG, F.BRANDMAL, F.LAUFFEUER, F.GLUTSTAHL, F.FEUERWALZE, F.GLUTBETT, F.SCHMIEDE, F.SCHMELZPUNKT, F.FEUERSTURM, F.FEUERLINIE, F.RUECKZUENDUNG];
...
export const FIRE_BUILDS = [
  ...
  ["Zunder + Kern", () => fixedPolicy([F.ZUNDER, ...CORE], fixedOpts)],
];
...
// ---- Blitz ----
const STACK_BUILD = [L.KETTENBLITZ, L.BLITZSCHLAG, L.ABLEITER, L.IONENFELD, L.RESTSTROM, L.KURZSCHLUSS, L.BLITZFAENGER, L.LICHTBOGEN, L.LADUNGSSERIE, L.VORENTLADUNG, L.GEWITTERFRONT, L.ENTLADUNG, L.SPANNUNGSSTAU, L.SERIENSCHUTZ];
const CRIT_BUILD = [L.LADUNGSSERIE, L.VORENTLADUNG, L.GEWITTERFRONT, L.ENTLADUNG, L.SPANNUNGSSTAU, L.ABLEITER, L.RESTSTROM, L.IONENFELD, L.BLITZSCHLAG, L.KETTENBLITZ, L.KURZSCHLUSS, L.BLITZFAENGER, L.LICHTBOGEN, L.SERIENSCHUTZ];
