...
describe("Legendäre Perks — Hooks (Legendär-Perks-Rework #203)", () => {
  ...
  const POOL = ["L_MONO"];                                                           // Pool-Erweiterung: Farb-Legendäres (scoreMult-Hook)

  it("die 12 Legendären sind legendär; die Erstgen (L1/L3/L5/L7–L11) ist entfernt", () => {
...
describe("Seltene Perks (#71, Phase 2a)", () => {
  ...
  it("V2 §22.4 / #203 + Pool: genau die 12 Legendären sind legendär, alles andere normal", () => {
    const LEGENDARY = new Set(["L2", "L4", "L6", "L_UMV", "L_ZINS", "L_VAB", "L_HENK", "L_ECHO", "L_SAMM", "L_BRENN", "L_PATT", "L_MONO"]);
    for (const p of PERK_LIST) {
