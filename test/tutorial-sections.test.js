...
describe("Tutorial-Sektionen · das Höhenbudget", () => {
  ...
  it("Gegenprobe: eine knappe volle Lektion bleibt im Budget", () => {
    /* Runde 3, Q17/Q16: `streak` und `pflanzzeichen` sind mit ihren Lektionen gestrichen;
       `einfrieren` ist jetzt der kleinste eingetragene Baustein — die Probe misst weiter
       dieselbe Umkehrung. */
    const fake = { id: "x", art: "voll",
      beats: [{ kind: "satz" }, { kind: "probierfeld", probe: "einfrieren" }, { kind: "tip" }] };
    const sec = { id: "y" };
