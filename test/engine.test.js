...
describe("resolveTrick — Grundausgänge (V2: ohne Leben)", () => {
  ...
  it("lastTrick.breakdown: Basis 100 und die Faktoren multiplizieren exakt auf gained (§17)", () => {
    ...
    expect((b.base + b.flats) * b.streakMult * b.perkMult * b.formMult * b.critMult + (b.fireDirect || 0) + (b.iceDirect || 0)).toBeCloseTo(b.total); // + Glut-/Eis-Dividende (direkt, am Stack vorbei)
