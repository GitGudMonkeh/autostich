/* #perkart — emblems for the perk selection on the desktop (from 1280 px).
   -------------------------------------------------------------------------------------------------
   ...
   image data. The bytes are fetched when an <img> actually renders, and it only renders from 1280 px
