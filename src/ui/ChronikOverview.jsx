...
/* Chronik-Kartenübersicht (§22.11): alle 40 Karten in aktueller Reihenfolge — nur Anzeige,
   mit Formations- und Rollen-Markern. Öffnet aus der Chronik heraus. */
            ...
            <div key={s} className="flex items-center gap-2">
              ...
              <div className="grid grid-cols-5 gap-1.5 flex-1">
                {cards.slice(s * SEGMENT_SIZE, s * SEGMENT_SIZE + SEGMENT_SIZE).map((c, k) => {
                  ...
                  return (
                    <div key={pos} className="relative rounded-lg flex flex-col items-center justify-center"
                      style={{ aspectRatio: "3 / 4", background: "#20202a", border: `2px solid ${inForm ? "#5ab87a" : col + "55"}` }}
