...
export function SkillSelect({ offer = null, doors = null, onPick, onDecline, onReroll, onChooseDoor, onCallFocus, onUpgradeSkill,
  ...
  const rerollBuy = rerollOfferWith(state, rerollTokens, !atDoors && offerIds.some(isLegendarySkill));
  // `offered` faellt weg, sobald weder ein Gratis-Wurf uebrig ist noch Muenzen existieren (Kampagne Ebene 1).
  const canReroll = !!onReroll && (atDoors || !!offer) && rerollBuy.offered;
