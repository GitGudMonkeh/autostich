...
export const GUIDES = {
  ...
  lightning: {
    ...
    pillars: [
      { glyph: "✦", color: "#e879f9", name: "Crit", text: `Dein Ertrag: ein Crit vervielfacht den Sieg-Score. Blitz erzeugt sowohl die Crit-Chance als auch den Crit-Multiplikator **selbst**; beides wächst mit jedem gehaltenen Blitz-Skill.` },
    ...
    principle: [
      ...
      { tag: "Serie", text: `**Serie ist Treibstoff.** Manche Blitz-Skills verwandeln deine Serie direkt in Ladung oder Crit-Chance; Siege am Stück halten den Sturm am Laufen.` },
    ],
  },
  ...
  ice: {
    ...
    kernidee: `Du **frierst Karten zu Gletschern fest**; sie sammeln unaufhaltsam **Masse** an; wenn ein Gletscher **bricht**, entlädt sich ein gewaltiger Score, der auf seine Nachbarn übergreift. Wo Pflanze in die Tiefe wächst, wächst Eis in die **Fläche**.`,
    pillarsLabel: `Die drei Säulen`,
    pillars: [
      { glyph: "❆", color: "#5ec8f0", name: "Masse", sub: "· die Ressource", text: `Sie sammelt sich auf dem **Brettfeld** an (nicht auf der Karte), jeden Durchlauf ein Stück, ganz von selbst bei Sieg wie Niederlage, und mehr, wenn ein Gletscher gewinnt. Masse fällt nie.` },
      ...
      { glyph: "▦", color: "#5a9fd4", name: "Das Cluster", sub: "· der Multiplikator", text: `Gletscher **nebeneinander** verstärken einander: je dichter das Feld, desto heftiger jeder Bruch. Ein Bruch kann eine **Kaskade** durchs ganze Cluster auslösen.` },
    ],
    loop: {
  ...
  // ---------------------------------------------------------------- PFLANZE
  plant: {
    subtitle: `Der langsamste, aber unaufhaltsame Archetyp: du ziehst einen Garten hoch, der mit jedem Durchlauf mehr Score trägt.`,
    kernidee: `Siege lassen deine Karten **wachsen**, bis sie dauerhaft grün werden und gemeinsam ein Feld bilden. Kein Sofort-Ertrag: ein Garten, der langsam anschwillt und dann alles überwuchert.`,
    pillarsLabel: `Die drei Ressourcen`,
    pillars: [
    ...
    loop: {
      ...
      steps: [
        ...
        `Je größer das grüne Feld, desto mehr Ertrag, und mehr Siege bedeuten wieder mehr Wachstum.`,
      ],
