...
export function Battlefield({ lastTrick, remaining = TRICKS_PER_CYCLE, deckLen = TRICKS_PER_CYCLE, flipMs = 1000, pe = {}, heat = null, lightning = null, oppDeck = "stat", score = 0,
  ...
  deckA1 = null, deckA2 = null, bgFx = null, bgFinisher = null, auroraDeck = false, emberDeck = false, starfieldDeck = false, cubematrixDeck = false, cubematrixSun = true, cubematrixWire = false,
  ...
  useEffect(() => {
    ...
    if (w && bgFinisher === "embers" && !reduced && !lite) audio.play("fx_embers", { gain: CARDFLIP_GAIN_CONST * 0.8 });
        ...
        <>
          <div aria-hidden="true" className="absolute inset-0 z-[2] pointer-events-none">
            <Suspense fallback={null}>
              <CubeMatrixField mode="field" color={deckA1} color2={deckA2 || deckA1} deckColored={cubematrixDeck} reduced={reduced} lite={lite} sun={cubematrixSun} wire={cubematrixWire} />
            </Suspense>
          </div>
