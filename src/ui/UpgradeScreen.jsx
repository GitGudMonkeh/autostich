...
const BR = [
  ...
  { key: "rar", name: "Rarität", desc: "Angebots-Qualität", color: VI, nodes: [
    { id: "R1", rom: "I",   eff: "RareShift 1", det: "bessere Odds", cost: 6 },
    { id: "R2", rom: "II",  eff: "RareShift 2", det: "bessere Odds", cost: 10 },
    { id: "R3", rom: "III", eff: "RareShift 3", det: "bessere Odds", cost: 18 },
  ]},
