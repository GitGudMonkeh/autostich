/* #cornerart — corner ornaments for the two selection card heads on the desktop (from 1400 px).
   -------------------------------------------------------------------------------------------------
   ...
   are fetched when an <img> actually renders, and it only renders from 1400 px (gate in
