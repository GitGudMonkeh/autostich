...
/* Archetyp-Karteneffekt „Feuer" — Brennender Kartenkopf (docs/archetyp-karteneffekte.md §5.2, Redesign).
   ...
   Rauch. Die HITZE (0..1) blendet zwischen vier abgestimmten Phasen (20/50/80/100 %) über — unter 20 % aus 0
   eingeblendet. #neon: Farbgebung nicht warm-orange, sondern der Neon-Seiden-Verlauf über die Flammenhöhe (unten
   blau → Mitte magenta → oben rot glühend, Weiß nur aus additiver Überlappung). Kein Scorch.
  ...
  useEffect(() => {
    ...
    const update = (ticker) => {
      ...
      for (let i = 0; i < maxFlames; i++) {
        ...
        // #neon: Jedes Partikel bekommt EINEN Flat-Tint aus dem vertikalen Neon-Verlauf nach seiner Höhe (age/life): unten
