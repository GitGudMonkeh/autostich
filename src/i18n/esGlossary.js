...
import { WIN_MASS as G_WIN_MASS, EWIGER_FROST as G_EWIGER_FROST, THRESHOLDS as G_THRESHOLDS,
  ...
  GEO_FLAECHE as G_FLAECHE, BURST_AT as G_BURST_AT, FIRN_REFILL_TARGET as G_REFILL, FIRN_DRAW as G_DRAW,
  FIRN_GROUND as G_GROUND } from "../game/glacier.js";
...
const E = [
  ...
  // exp skill rework (catálogo inactivo): calor, marca, calor blanco y forja siguen la fuente alemana; ceniza y brasa de ceniza han desaparecido.
  ["heat", "Calor", "Las victorias con un margen de 3 o más calientan la barra de calor (0–100 %): +1 % por punto de margen por encima de 2, sin tope. Las derrotas enfrían −2 %. Por cada 10 % de calor acumulado, cada victoria cuenta +2 % de puntuación como multiplicador propio. Las habilidades de Fuego usan el calor.", ["calor", "barra de calor"]],
  ["brand", "Marca", "Una carta rival marcada pierde sus puntos de marca en valor en el siguiente ciclo (nunca por debajo de 0). Las marcas de distintas fuentes se suman; se renuevan cada ciclo y solo se acumulan entre ciclos con Núcleo Solar.", ["marca", "marcas", "marcada", "punto de marca", "puntos de marca"]],
  ["whiteheat", "Calor blanco", "Con la habilidad Calor Blanco la barra de calor llega al 200 %, y por encima del 100 % el multiplicador de calor sigue subiendo, más inclinado. No tiene disipación propia: por encima del 100 % solo enfría lo que también enfría por debajo (derrotas, consumidores).", ["calor blanco"]],
  ["forge", "Forjar", "El calor se convierte en valor de carta permanente: al final del ciclo la Forja da +3 de valor a tu carta más baja y cuesta calor; el Acero de Damasco forja sin coste. El valor forjado se queda en la carta, incluso tras cambiar de habilidad.", ["forjar", "forjada", "forjado", "forja", "valor forjado"]],
  ...
  ["freeze", "Nieve", `La nieve está como reserva sobre la celda del tablero, separada de la masa del glaciar. En cada ciclo cada celda abierta congela +${num(G_GROUND)} de nieve y ${Number.isFinite(G_DRAW) ? `entrega hasta ${G_DRAW} de ella` : "la entrega entera"} a tus glaciares — repartida entre todos, el más cercano recibe la mayor parte y ninguno se queda vacío. Si congelas un glaciar sobre una celda cargada, la nieve acumulada se convierte en su reserva del suelo; empieza vacío y tira de ella en cada ciclo hasta volver a las ${G_REFILL} de masa completas (solo la diferencia, nunca más allá), hasta que la reserva se vacía. El suelo abierto lo cargan Permafrost, Ventisca y Edad de Hielo, nunca bajo un glaciar.`, ["nieve"]],
