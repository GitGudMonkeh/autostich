...
export default {
  ...
  "ability.SK_ICE_03.desc": `En cada ciclo, las celdas sin congelar acumulan nieve en su reserva del suelo: +1 a 2 celdas de distancia del glaciar más cercano, +2 a partir de 3. Las 8 celdas que rodean directamente un glaciar quedan vacías. Si más tarde se congela aquí un glaciar, la reserva lo rellena al inicio del ciclo.`,
  "ability.SK_ICE_04.name": "Compactación",
  "ability.SK_ICE_04.desc": `Si un edificio sube el valor de combate de una carta de glaciar, esa bonificación no se juega, sino que se convierte en masa: +0,25 de masa por punto. Los edificios de puntuación no se ven afectados.`,
  ...
  "ability.SK_ICE_10.desc": `Los umbrales de masa más altos estallan con más fuerza: potencia ×1,6 en vez de ×1,5 en el umbral 2, ×2,6 en vez de ×2,2 en el 3.`,
  ...
  "ability.SK_ICE_13.desc": `Un glaciar estalla ya con 9 de masa, en vez de ${num(G_THRESHOLDS[G_THRESHOLDS.length - 1])}.`,
  ...
  "ability.SK_ICE_16.desc": `Cuando un glaciar estalla, sus vecinas que no son glaciares reciben +2 de valor de baza en el ciclo siguiente. Con el puente de hielo, esto vale para la vecindad de 8.`,
