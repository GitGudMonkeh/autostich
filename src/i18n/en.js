...
export default {
  ...
  "rail.critChance.over": "+{pp} over 100% · +{mult}× mult",
  "rail.wins": "Wins",
  "rail.losses": "Loss.",
  "rail.rate": "Rate",
  "rail.tricks": "Tricks",
  ...
  "form.confirm.title": "Formation difference since the start of the cycle",
  "form.delta": "{sign}{pct}%",
  "form.energyLeft": " · {n} energy left",
  "form.energy": "Energy",
  "form.energy.buy": "+1 swap",
  "form.energy.buy.title": "Buy one extra swap for this formation phase - {n} left, expires with the phase",
  ...
  "reroll.free": "{n} free",
  "reroll.then": "then",
  "skill.reroll.doors": "🎲 Reroll the doors",
  ...
  "focus.broke": "You are still short of coins for this.",
  "focus.called": "Called",
  "focus.paid": "paid",
  "upgrade.open": "Upgrade a skill",
  "upgrade.from": "from",
  "upgrade.eyebrow": "Your skills",
  ...
  "board.play": "▶ Play",
  "board.locked": "🔒 Unlocks once every deck is unlocked and each of the four factions has been part of a run you played to the end; one skill from it is enough, and several factions count in the same run. Abandoned runs don't count.",
  ...
  "guide.subtitle": "How to play each faction, click through",
  "guide.archOf": "Faction {n} of {total}",
  ...
  "guide.nav.archetypes": "Factions",
  "guide.nav.note": "The guide explains how a faction plays. Terms and special rules live in the glossary.",
  ...
  "hint.h2.body": "Lightning is your first faction. A crit multiplies a trick's score. Lightning skills make crits more likely, and every crit fills your charge bar.",
  "hint.h2b.body": "From now on Fire is available next to Lightning, swipe right. Skills mix freely. Further factions are unlocked in the upgrade tree.",
  ...
  "hint.c4.body": "A legendary skill from your active factions: its own slot, no swapping.",
  ...
  "fxsyn.spezial.desc": "The four faction effects (fire · lightning · ice · plant) are always active. Pick the colour: fixed neon standard or the colour of your active deck.",
  ...
  "start.ranked.locked": "View the weekly ranking. Playing unlocks once every deck is unlocked and each of the four factions has been part of a run you played to the end (one skill from it is enough)",
  ...
  "privacy.sec.board.body": "When you put a run on the leaderboard: the nickname you chose, score, cycles, tricks, factions, perks, skills, the seed, how far your upgrade tree was built (how many nodes were unlocked) and the run\u2019s metrics (best streak, formations, crits, wins, best trick, score shares). The nickname is visible to every player; so pick something nobody can find you by. Without a nickname nothing is published.",
  ...
  "start.campaign.state": "Tier {level} · Run {run} of {runs}",
  "start.campaign.fresh": "Tier {level} · new",
  ...
  "campaign.over.passed": "Run {n} cleared",
  "campaign.over.failed": "Run {n} not cleared",
  "campaign.over.score": "Final score",
  "campaign.over.need": "of {n}M needed",
  "campaign.over.overThreshold": "Score above the threshold",
  "campaign.over.mark": "Threshold {n}",
  "campaign.over.tasks": "Contracts fulfilled",
  "campaign.over.tasksOf": "of {n}",
  "campaign.over.mult": "Score multiple",
  "campaign.over.multMissed": "{n}× missed",
  "campaign.over.steps": "Total",
  "campaign.over.stepsGain_one": "+{n} step",
  "campaign.over.stepsGain_other": "+{n} steps",
  "campaign.over.rarity": "Your reward arrives as",
  "campaign.over.pick": "Choose reward",
  "campaign.over.capped": "Epic from tier 2",

  "campaign.pick.title": "Reward for run {n}",
  "campaign.pick.lasts": "Lasts until the end boss. Or until a run falls.",
  "campaign.pick.take": "Take",
  "campaign.pick.new": "New in your collection",
  "campaign.pick.upgrade": "Upgrade, replaces the lower step",
  "campaign.pick.holding": "You hold {rarity}, {value}",
  "campaign.pick.axis": "Rolled: {axis}",

  "campaign.unlock.title": "NEWLY UNLOCKED",
  "campaign.unlock.next": "On to run {n}",
  ...
  "campaign.unlock.coins.text": "Reroll, energy, build field, focus.",
  ...
  "campaign.won.next": "TIER {level} UNLOCKED",
  "campaign.won.harder": "Higher thresholds",
  "campaign.won.newUnlocks": "New unlocks",
  "campaign.won.newBosses": "New bosses",
  "campaign.won.begin": "Begin tier {level}",

  "campaign.reward.sold": "Pay",
  "campaign.reward.sold.text": "Every trick you win brings {v} more base points.",
  "campaign.reward.feldzeichen": "Standard",
  "campaign.reward.feldzeichen.text": "Whatever your {axis} adds beyond ×1 counts {v} % more.",
  "campaign.reward.steigbrief": "Ascent",
  "campaign.reward.steigbrief.text": "Every ten cycles your score bonus grows by {v} %.",
  "campaign.reward.waffenrecht": "Right of Arms",
  "campaign.reward.waffenrecht.text": "Every card in your deck is permanently {v} points stronger.",
  "campaign.reward.wetzstein": "Whetstone",
  "campaign.reward.wetzstein.text": "At the end of every cycle your weakest card gains {v} points.",
  "campaign.reward.zehnt": "Tithe",
  "campaign.reward.zehnt.text": "Every card in the opposing deck is permanently {v} points weaker.",
  "campaign.reward.pfruende": "Prebend",
  "campaign.reward.pfruende.text": "You receive {v} more coins every cycle.",
  "campaign.reward.handelsbrief": "Charter of Trade",
  "campaign.reward.handelsbrief.text": "Everything you buy costs {v} % less.",
  "campaign.reward.mitgift": "Dowry",
  "campaign.reward.mitgift.text": "The run begins with {v} coins.",
  "campaign.reward.lehen": "Fief",
  "campaign.reward.lehen.text": "Your build field has {v} more cells.",
  "campaign.reward.fahnenrecht": "Right of Banner",
  "campaign.reward.fahnenrecht.text": "You have {v} more energy in every layout phase.",
  "campaign.reward.standhaftigkeit": "Steadfastness",
  "campaign.reward.standhaftigkeit.text": "Your streak survives {v} losses per cycle.",
  "campaign.reward.losentscheid": "Casting Lot",
  "campaign.reward.losentscheid.text": "Tricks you lose by at most {v} count as wins.",
  "campaign.reward.lueckenschluss": "Gap Closure",
  "campaign.reward.lueckenschluss.text": "In every formation {v} cards may fail to match.",
  "campaign.reward.fuersprache": "Advocacy",
  "campaign.reward.fuersprache.text": "The next run's threshold drops by {v} %.",
  "campaign.reward.doppelwahl": "Double Choice",
  "campaign.reward.doppelwahl.text": "After a fulfilled contract you choose two loot pieces instead of one.",

  "campaign.axis.streak": "Streak",
  "campaign.axis.streak.mult": "streak multiplier",
  "campaign.axis.perk": "Perks",
  "campaign.axis.perk.mult": "perk multiplier",
  "campaign.axis.form": "Formation",
  "campaign.axis.form.mult": "formation multiplier",
  "campaign.axis.core": "Formation core",
  "campaign.axis.core.mult": "formation core multiplier",
  "campaign.axis.afterglow": "Afterglow",
  "campaign.axis.afterglow.mult": "afterglow multiplier",
  "campaign.axis.architect": "Buildings",
  "campaign.axis.architect.mult": "building multiplier",
  "campaign.axis.crit": "Crit",
  "campaign.axis.crit.mult": "crit multiplier",
  "campaign.axis.fire": "Fire",
  "campaign.axis.fire.mult": "fire multiplier",
  "campaign.axis.plant": "Plant",
  "campaign.axis.plant.mult": "plant multiplier",
