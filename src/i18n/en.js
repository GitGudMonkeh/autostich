...
export default {
  ...
  "skill.passive.ice": "Every ice skill freezes one of your cards as a glacier, including a swap when your skill slots are full. It can no longer be moved in any order phase, but gathers mass every cycle and eventually bursts over its neighbours. Open ground freezes too: every free cell builds up snow and hands it to your glaciers — the fewer glaciers you hold, the more each one receives. From {declineFrom} ice skills held, even declining an offer freezes a glacier, so you can hold more glaciers than skill slots.",
