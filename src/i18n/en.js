...
export default {
  ...
  "tut.eis.einfrieren.title": "Freezing",
  "tut.eis.einfrieren.0": "How new glaciers come to be.",
  ...
  "tut.sz.ee.s1": "**Every ice skill freezes one card.** Including a swap with full skill slots. You pick the card yourself; after that it stays on its position.",
  "tut.sz.ee.s2": "**From {n} ice skills, declining freezes too.** You can then hold more glaciers than skill slots.",
  "tut.sz.ee.merk": "**Building densely pays.** Glaciers side by side amplify each other on every burst.",
