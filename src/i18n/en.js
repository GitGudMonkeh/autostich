...
export default {
  ...
  "tut.grundlagen.wasist.1": "{cards} cards in a fixed order, {suits} suits with values {rankMin} to {rankMax}. Your order stays for the whole run and can only be changed in the lineup. The opponent reshuffles before every cycle.",
  ...
  "tut.grundlagen.serie.2": "Same cards, different order, different streak. The lineup is what decides that.",
