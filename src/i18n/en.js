...
export default {
  ...
  "app.restart.help.campaign": "In the campaign a restart costs only this attempt: the same step starts over and your unlocks stay.",
  ...
  "campaign.boss.grants": "Clearing it unlocks: {name}",
