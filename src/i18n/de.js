...
export default {
  ...
  "skill.passive.ice": "Jeder Eis-Skill friert eine deiner Karten als Gletscher fest, auch wenn du bei vollen Skill-Slots tauschst. Sie lässt sich dann in keiner Aufstellung mehr verschieben, sammelt dafür jeden Durchlauf Masse und bricht schließlich über ihre Nachbarn. Auch der offene Boden friert: jedes freie Feld legt Schnee an und gibt ihn an deine Gletscher ab — je weniger Gletscher du hast, desto mehr bekommt jeder einzelne. Ab {declineFrom} gehaltenen Eis-Skills friert sogar das Ablehnen eines Angebots einen Gletscher ein, du kannst also mehr Gletscher haben als Skill-Slots.",
