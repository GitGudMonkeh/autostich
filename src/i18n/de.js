...
export default {
  ...
  "bar.fire.badge.schmiede.title": "Schmiede: liegen am Rundenende mindestens {n} Hitze an, erhält deine niedrigste Karte dauerhaft +{v} Wert. Die Hitze bleibt.",
  ...
  "skill.passive.plant": "Jeder Sieg lässt die Siegkarte wachsen: +{win} Wachstum, dazu +{perForm} je Formation an ihrer Position. Niederlagen geben nichts. Ab {green} Wachstum ist die Karte grün und gilt als eigene Farbe für jede Formation, die Farbe liest. Ab {bloom} blüht sie, und ein Sieg mit ihr gibt +{score} Basis-Score je grüner Karte in ihren Formationen. Beim Zählen wiegt eine blühende Karte {weight} grüne, je {per} weitere Wachstumspunkte eine mehr.",
