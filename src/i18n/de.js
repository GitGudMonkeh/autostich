...
export default {
  ...
  "tut.fortgeschritten.laenge.1": "Der Regler geht bis {segment}, weil dort das Segment endet. Was danach kommt, ist die nächste Lektion.",
  ...
  "tut.fortgeschritten.segmente.0": "Formationen enden am Segment, also nach {segment} Karten. Hier liegen neun rote hintereinander, quer über zwei Grenzen. Solange die zu sind, zählen nur die in der Mitte.",
  "tut.fortgeschritten.segmente.1": "Schalte die Grenzen auf.",
  "tut.fortgeschritten.segmente.2": "Zwei Wege, eine Grenze zu öffnen. Der Perk {segWork} öffnet auf Stufe I eine, auf II zwei, auf III alle, und auf IV zusätzlich einen Zuschlag auf jede Karte, die eine Grenze überschreitet. Das Gebäude {pillar} öffnet die Grenze der Zeilen, die es abdeckt.",
  "tut.fortgeschritten.segmente.3": "Eine offene Grenze ändert keine einzige Karte. Sie erlaubt nur, dass eine Formation weiterläuft, und weil der Faktor mit der Länge steigt, zahlt genau das doppelt.",
  ...
  "tut.fortgeschritten.glut.1.label": "Feuer und Architekt",
  "tut.fortgeschritten.glut.1": "Feuers Glutdividende ist ein Score, der direkt gezahlt wird und an keinem Multiplikator vorbeikommt. Weder Serie noch Crit noch eine Karten-Formation heben sie. Die Struktur des Architekten schon, und die sogar verstärkt.",
  "tut.fortgeschritten.glut.2.label": "Was dabei herauskommt",
  "tut.fortgeschritten.glut.2": "Eine volle Zeile gibt {rowFactor} auf den Score, aber {rowAmp} auf die Dividende. Eine volle Spalte {colFactor} und {colAmp}. Für Feuer ist die Geometrie damit der einzige Hebel auf den Teil, den sonst nichts erreicht.",
  "tut.fortgeschritten.glut.3": "Die Verdopplung gilt nur für die Glutdividende. Auf den übrigen Score wirkt dieselbe Struktur mit ihrem normalen Faktor.",
  "tut.fortgeschritten.klinge.title": "Glühende Klinge und Blitz",
  "tut.fortgeschritten.klinge.0.label": "Feuer und Blitz",
  "tut.fortgeschritten.klinge.0": "Feuer sorgt dafür, dass du gewinnst. Blitz sorgt dafür, dass sich jeder Sieg lohnt. Die Ascheschmiede legt {forgeValue} Kartenwert auf deine schwächste Karte, die Glühende Klinge {glowV1} ab {glowT1} % Hitze, {glowV2} ab {glowT2} % und {glowV3} bei {glowT3} %.",
  "tut.fortgeschritten.klinge.1.label": "Warum sich das trägt",
  "tut.fortgeschritten.klinge.1": "Höhere Werte heißen weniger Niederlagen, und jede Niederlage setzt die Serie auf null. Jeder Serienpunkt ist {streakPct} %. Blitz liefert dann die Crits: {critPerSkill} % je gehaltenem Blitz-Skill, und ein Crit ist {critMult}×. Er trifft einen Stich, der ohnehin schon hoch steht.",
  "tut.fortgeschritten.klinge.2": "Ein Haken gehört dazu: die Glühende Klinge zählt ab der zweiten Stufe nur, wenn dein letzter Sieg {glowM2} Vorsprung hatte, ab der dritten {glowM3}. Eine Niederlage setzt das auf null.",
  "tut.fortgeschritten.klinge.3": "Beide Kombinationen haben dieselbe Form: etwas macht deine Stiche größer, etwas anderes multipliziert genau das.",
  /* ===================== TUTORIAL =====================
