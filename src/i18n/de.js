...
export default {
  ...
  "tut.eis.einfrieren.title": "Einfrieren",
  "tut.eis.einfrieren.0": "Wie neue Gletscher entstehen.",
  ...
  "tut.sz.ee.s1": "**Jeder Eis-Skill friert eine Karte fest.** Auch ein Tausch bei vollen Skill-Slots. Du wählst die Karte selbst, danach bleibt sie auf ihrer Position.",
  "tut.sz.ee.s2": "**Ab {n} Eis-Skills friert auch das Ablehnen.** Du kannst dann mehr Gletscher haben als Skill-Slots.",
  "tut.sz.ee.merk": "**Dicht bauen lohnt sich.** Gletscher nebeneinander verstärken sich gegenseitig bei jedem Bruch.",
