...
export default {
  ...
  "building.eff.target.value": "{which} Karte +{n} Stichwert, die übrigen Zellen +{half}",
  "building.eff.target.score": "{which} Karte +{n} Score, die übrigen Zellen +{half}",
  ...
  "bar.fire.badge.glutbett.title": "Glutbett: Niederlagen kühlen nur {cool} % statt 6 % und nie unter {n} %.",
  ...
  "bar.fire.badge.glow.title": "Glühende Klinge: +1 Wert auf alle Karten je {step} % Hitze. Zählt nur bis {max} % Hitze, auch mit Weißglut.",
  ...
  "bar.ice.chip.title": "Gletscher · Masse {mass} · Stufe {tier} · bricht bei {at}",
  "bar.ice.chip.title.burst": "Gletscher · Masse {mass} · Stufe {tier} · BRICHT (Schwelle {at})",
  "bar.ice.seg": "Schwelle {n} Masse",
  "bar.ice.seg.burst": "Schwelle {n} Masse · hier bricht er",
  "bar.ice.burstAt": "Bruch ab",
  ...
  "bar.plant.base": "Basis-Score",
  "bar.plant.grown": "Gewachsen",
  "bar.plant.grown.unit": "Wachstum gesamt",
  "bar.plant.state.full": "Vollständig grün",
  "bar.plant.state.green": "Grün {pct} %",
  "bar.plant.share": "Grün-Anteil des Feldes",
  "bar.plant.share.badge": " · VOLLSTÄNDIG",
  "bar.plant.share.value": "{green} / {total} · {pct} %",
  "bar.plant.share.title": "Anteil grüner Karten am Feld (blühende zählen mit).",
  "bar.plant.stage.grey": "Grau",
  "bar.plant.stage.grey.title": "Noch graue Karten (Balken = Ø Fortschritt bis {need} Wachstum, dann grün).",
  "bar.plant.stage.green": "Grün",
  "bar.plant.stage.green.title": "Grüne Karten (Balken = Ø Fortschritt bis {need} Wachstum, dann blühend).",
  "bar.plant.stage.bloom": "Blühend",
  "bar.plant.stage.bloom.title": "Blühende Karten: ein Sieg mit ihnen gibt Basis-Score je grüner Karte in ihren Formationen.",
  "bar.plant.strip.grey": "Grau {growth}/{need}",
  "bar.plant.strip.green": "Grün {growth}/{need}",
  ...
  "rail.critChance.over": "+{pp} über 100 % · +{mult}× Mult",
  "rail.wins": "Siege",
  "rail.losses": "Verl.",
  "rail.rate": "Quote",
  "rail.tricks": "Stiche",
  ...
  "bf.bd.perks": "Perks",
  "bf.bd.perks.title": "Multiplikator aus Perks und Familien, dazu die Score-Gebäude des Architekten.",
  "bf.bd.form": "Form",
  ...
  "form.confirm.title": "Formations-Differenz seit Durchlaufbeginn",
  "form.delta": "{sign}{pct} %",
  "form.energyLeft": " · noch {n} Energie",
  "form.energy": "Energie",
  "form.energy.buy": "+1 Tausch",
  "form.energy.buy.title": "Einen zusätzlichen Tausch für diese Aufstellphase kaufen — noch {n} möglich, verfällt mit der Phase",
  ...
  "form.spalier": "Spalier:",
  "form.spalier.none": "noch keine grün gesäumte Grenze",
  "form.spalier.open_one": "{count} grün gesäumte Grenze offen",
  "form.spalier.open_other": "{count} grün gesäumte Grenzen offen",
  "form.pfeiler": "Pfeiler:",
  "form.pfeiler.open_one": "{count} Grenze offen, an der Zeile des Gebäudes",
  "form.pfeiler.open_other": "{count} Grenzen offen, an den Zeilen der Gebäude",
  ...
  "skill.reroll": "🎲 Neu würfeln",
  "skill.reroll.buy": "🎲 Neu würfeln",
  "reroll.free": "{n} gratis",
  "reroll.capped": "Deckel erreicht",
  "reroll.left_one": "noch {n} Neuwurf",
  "reroll.left_other": "noch {n} Neuwürfe",
  "reroll.then": "dann",
  "skill.reroll.doors": "🎲 Türen neu würfeln",
  ...
  "focus.broke": "Dafür fehlen dir noch Münzen.",
  "focus.called": "Gerufen",
  "focus.paid": "bezahlt",
  "upgrade.open": "Skill aufwerten",
  "upgrade.from": "ab",
  "upgrade.eyebrow": "Deine Skills",
  ...
  "carddetail.plant.bloom": "Blühend",
  "carddetail.plant.green": "Grün",
  "carddetail.plant.grey": "Grau",
  ...
  "card.forged.title": "Geschmiedet +{n} Kartenwert (dauerhaft)",
  "card.ring.grown": "Wachstum {growth} / {cap} → blühend",
  "card.ring.ripening": "Wachstum {growth} / {cap} → grün",
  ...
  "cardgrid.segbridge.title.spalier": "Spalier: diese Grenze ist grün gesäumt, Formationen dürfen zwischen Segment {a} und {b} weiterlaufen",
  "cardgrid.segbridge.title.arch": "Pfeiler: das Gebäude öffnet diese Grenze, Formationen dürfen zwischen Segment {a} und {b} weiterlaufen",
  ...
  "arch.reroll": "🎲 Baupläne neu würfeln",
  ...
  "stats.archUse": "Fraktions-Nutzung",
  ...
  "fxsyn.spezial.desc": "Die vier Fraktions-Effekte (Feuer · Blitz · Eis · Pflanze) sind immer aktiv. Wähle die Farbe: feste Neon-Standardfarbe oder die Farbe deines aktiven Decks.",
  ...
  "privacy.sec.board.body": "Wenn du einen Lauf in die Bestenliste stellst: dein selbst gewählter Nickname, Score, Durchläufe, Stiche, Fraktionen, Perks, Skills, der Seed, der Ausbaustand deines Upgrade-Baums (wie viele Knoten freigeschaltet waren) und die Kennzahlen des Laufs (beste Serie, Formationen, Crits, Siege, bester Stich, Score-Anteile). Der Nickname ist für alle Spieler sichtbar; wähle also nichts, worüber man dich findet. Ohne Nickname wird nichts veröffentlicht.",
  ...
  /* ---- Zwischenaufgaben (Aufträge) — docs/zwischenaufgaben.md ----
     Nur in einem Lauf sichtbar, der über den Knopf „Aufträge" gestartet wurde. */
  "start.contracts": "Aufträge",
  ...
  "contract.formation.wiederholung": "Wiederholung",
  ...
  "contract.task.vollbrett.text": "Bringe {n} der 40 Positionen in mindestens eine Formation.",
  ...
  "contract.task.brecher.text": "Gewinne zehn Stiche mit einem Kampfwert über {n}.",
  ...
  "contract.loot.zehrgeld.name": "Zehrgeld",
  "contract.loot.zehrgeld.t1": "Du bekommst sofort 15 Münzen.",
  "contract.loot.zehrgeld.t2": "Du bekommst sofort 25 Münzen.",
  "contract.loot.zehrgeld.t3": "Du bekommst sofort 50 Münzen.",
  "contract.loot.zehrgeld.t4": "Du bekommst sofort 100 Münzen.",
  "contract.loot.muenzrecht.name": "Münzrecht",
  "contract.loot.muenzrecht.t1": "Jeder Durchlauf zahlt 1 Münze zusätzlich, die nächsten 15 lang.",
  "contract.loot.muenzrecht.t2": "Jeder Durchlauf zahlt 1 Münze zusätzlich, bis zum Laufende.",
  "contract.loot.muenzrecht.t3": "Jeder Durchlauf zahlt 2 Münzen zusätzlich, bis zum Laufende.",
  "contract.loot.muenzrecht.t4": "Jeder Durchlauf zahlt 4 Münzen zusätzlich, bis zum Laufende.",
  "contract.loot.ablass.name": "Ablass",
  "contract.loot.ablass.t1": "Ein abgelehnter Skill oder Perk zahlt anderthalbmal so viele Münzen.",
  "contract.loot.ablass.t2": "Ein abgelehnter Skill oder Perk zahlt doppelt so viele Münzen.",
  "contract.loot.ablass.t3": "Ein abgelehnter Skill oder Perk zahlt zweieinhalbmal so viele Münzen.",
  "contract.loot.ablass.t4": "Ein abgelehnter Skill oder Perk zahlt dreimal so viele Münzen.",
  "contract.loot.freizug.name": "Freizug",
  "contract.loot.freizug.t1": "Jede Aufstellphase beginnt mit 1 Energie mehr, die nächsten fünf lang.",
  "contract.loot.freizug.t2": "Jede Aufstellphase beginnt mit 1 Energie mehr, bis zum Laufende.",
  "contract.loot.freizug.t3": "Jede Aufstellphase beginnt mit 2 Energie mehr, bis zum Laufende.",
  "contract.loot.freizug.t4": "Jede Aufstellphase beginnt mit 2 Energie mehr. Übrige Energie zahlt am Phasenende doppelt.",
  "contract.loot.baurecht.name": "Baurecht",
  "contract.loot.baurecht.t1": "Das Baufeld trägt 1 Zelle mehr, bis zum Laufende.",
  "contract.loot.baurecht.t2": "Das Baufeld trägt 2 Zellen mehr, bis zum Laufende.",
  "contract.loot.baurecht.t3": "Das Baufeld trägt 3 Zellen mehr, bis zum Laufende.",
  "contract.loot.baurecht.t4": "Das Baufeld trägt 4 Zellen mehr, bis zum Laufende.",
  "contract.loot.aufstockung.name": "Aufstockung",
  "contract.loot.aufstockung.t1": "Ein gebautes Gebäude steigt sofort um eine Stufe.",
  "contract.loot.aufstockung.t2": "Zwei gebaute Gebäude steigen sofort um eine Stufe.",
  "contract.loot.aufstockung.t3": "Drei gebaute Gebäude steigen sofort um eine Stufe.",
  "contract.loot.aufstockung.t4": "Alle gebauten Gebäude steigen sofort um eine Stufe.",
  "contract.loot.lehrbrief.name": "Lehrbrief",
  "contract.loot.lehrbrief.t1": "Ein gehaltener Skill steigt ohne Münzen um eine Stufe.",
  "contract.loot.lehrbrief.t2": "Zwei gehaltene Skills steigen ohne Münzen um eine Stufe.",
  "contract.loot.lehrbrief.t3": "Drei gehaltene Skills steigen ohne Münzen um eine Stufe.",
  "contract.loot.lehrbrief.t4": "Bis zu vier gehaltene Skills steigen ohne Münzen um zwei Stufen.",
  "contract.loot.freibrief.name": "Freibrief",
  "contract.loot.freibrief.t1": "Die nächste Skill-Phase öffnet eine dritte Tür.",
  "contract.loot.freibrief.t2": "Die nächsten drei Skill-Phasen öffnen eine dritte Tür.",
  "contract.loot.freibrief.t3": "Jede Skill-Phase öffnet eine dritte Tür, bis zum Laufende.",
  "contract.loot.freibrief.t4": "Jede Skill-Phase öffnet eine dritte Tür, bis zum Laufende. Episch und Legendär erscheinen im Skill-Angebot häufiger.",
  "contract.loot.veredelung.name": "Veredelung",
  "contract.loot.veredelung.t1": "Im nächsten Skill-Angebot steht jeder Skill eine Stufe höher.",
  "contract.loot.veredelung.t2": "In den nächsten drei Skill-Angeboten steht jeder Skill eine Stufe höher.",
  "contract.loot.veredelung.t3": "In jedem Skill-Angebot steigen Normal und Selten um eine Stufe. Sehr selten bleibt.",
  "contract.loot.veredelung.t4": "In jedem Skill-Angebot steigt jede Stufe unter Episch um eine.",
  "contract.loot.auslage.name": "Auslage",
  "contract.loot.auslage.t1": "Die nächste Perk-Auswahl zeigt vier Perks statt drei.",
  "contract.loot.auslage.t2": "Jede Perk-Auswahl zeigt vier Perks statt drei.",
  "contract.loot.auslage.t3": "Jede Perk-Auswahl zeigt vier Perks statt drei, keiner davon Normal.",
  "contract.loot.auslage.t4": "Jede Perk-Auswahl zeigt vier Perks statt drei, keiner davon Normal oder Selten.",
  "contract.loot.beschau.name": "Beschau",
  "contract.loot.beschau.t1": "Im nächsten Perk-Angebot fällt kein Perk unter Selten.",
  "contract.loot.beschau.t2": "In jedem Perk-Angebot fällt kein Perk unter Selten.",
  "contract.loot.beschau.t3": "In jedem Perk-Angebot fällt kein Perk unter Sehr selten.",
  "contract.loot.beschau.t4": "In jedem Perk-Angebot fällt kein Perk unter Sehr selten. Legendäre erscheinen häufiger.",
  "contract.loot.freilos.name": "Freilos",
  "contract.loot.freilos.t1": "Du bekommst zwei Neuwürfe ohne Münzen.",
  "contract.loot.freilos.t2": "Jede Skill-Phase hat einen Neuwurf ohne Münzen.",
  "contract.loot.freilos.t3": "Jede Phase hat einen Neuwurf ohne Münzen, bei Skills, Perks und Gebäuden.",
  "contract.loot.freilos.t4": "Jede Phase hat einen Neuwurf ohne Münzen. Auch der legendäre Neuwurf kostet nur den normalen Preis.",
  "contract.loot.nachlass.name": "Nachlass",
  "contract.loot.nachlass.t1": "Jeder Neuwurf kostet ein Viertel weniger.",
  "contract.loot.nachlass.t2": "Jeder Neuwurf kostet die Hälfte.",
  ...
  "contract.leg.vollendung.text": "Ein gehaltener Skill deiner Wahl wird sofort episch. Alle anderen gehaltenen Skills steigen um eine Stufe.",
  "contract.leg.stadtrecht.name": "Stadtrecht",
  ...
  "start.campaign.state": "Ebene {level} · Lauf {run} von {runs}",
  "start.campaign.fresh": "Ebene {level} · neu",
  ...
  "campaign.held": "Gehaltene Rewards",
  ...
  "campaign.over.passed": "Lauf {n} bestanden",
  "campaign.over.failed": "Lauf {n} nicht bestanden",
  "campaign.over.score": "Endscore",
  "campaign.over.need": "von {n} Mio nötig",
  "campaign.over.overThreshold": "Score über der Schwelle",
  "campaign.over.mark": "Schwelle {n}",
  "campaign.over.tasks": "Erfüllte Aufträge",
  "campaign.over.tasksOf": "von {n}",
  "campaign.over.mult": "Score-Vielfaches",
  "campaign.over.multMissed": "{n}× verfehlt",
  "campaign.over.steps": "Summe",
  "campaign.over.stepsGain_one": "+{n} Stufe",
  "campaign.over.stepsGain_other": "+{n} Stufen",
  "campaign.over.rarity": "Dein Reward kommt als",
  "campaign.over.pick": "Reward wählen",
  "campaign.over.capped": "Episch ab Ebene 2",

  "campaign.pick.title": "Reward für Lauf {n}",
  "campaign.pick.lasts": "Bleibt bis zum Endboss. Oder bis ein Lauf fällt.",
  "campaign.pick.take": "Nehmen",
  "campaign.pick.new": "Neu in deiner Sammlung",
  "campaign.pick.upgrade": "Upgrade, ersetzt die niedrigere Stufe",
  "campaign.pick.holding": "Du hältst {rarity}, {value}",
  "campaign.pick.axis": "Ausgewürfelt: {axis}",

  "campaign.unlock.title": "NEU FREIGESCHALTET",
  "campaign.unlock.next": "Weiter zu Lauf {n}",
  ...
  "campaign.unlock.coins.text": "Neuwurf, Energie, Baufeld, Fokus.",
  ...
  "campaign.won.next": "EBENE {level} FREIGESCHALTET",
  "campaign.won.harder": "Höhere Schwellen",
  "campaign.won.newUnlocks": "Neue Freischaltungen",
  "campaign.won.newBosses": "Neue Bosse",
  "campaign.won.begin": "Ebene {level} beginnen",

  "campaign.reward.sold": "Sold",
  "campaign.reward.sold.text": "Jeder gewonnene Stich bringt {v} Grundpunkte mehr.",
  "campaign.reward.feldzeichen": "Feldzeichen",
  "campaign.reward.feldzeichen.text": "Was dein {axis} über ×1 hinaus bringt, zählt {v} % mehr.",
  "campaign.reward.steigbrief": "Steigbrief",
  "campaign.reward.steigbrief.text": "Alle zehn Durchläufe wächst dein Score-Bonus um {v} %.",
  "campaign.reward.waffenrecht": "Waffenrecht",
  "campaign.reward.waffenrecht.text": "Jede Karte in deinem Deck ist dauerhaft {v} Punkte stärker.",
  "campaign.reward.wetzstein": "Wetzstein",
  "campaign.reward.wetzstein.text": "Am Ende jedes Durchlaufs bekommt deine schwächste Karte {v} Punkte dazu.",
  "campaign.reward.zehnt": "Zehnt",
  "campaign.reward.zehnt.text": "Jede Karte im Gegnerdeck ist dauerhaft {v} Punkte schwächer.",
  "campaign.reward.pfruende": "Pfründe",
  "campaign.reward.pfruende.text": "Du bekommst jeden Durchlauf {v} Münzen mehr.",
  "campaign.reward.handelsbrief": "Handelsbrief",
  "campaign.reward.handelsbrief.text": "Alles, was du kaufst, kostet {v} % weniger.",
  "campaign.reward.mitgift": "Mitgift",
  "campaign.reward.mitgift.text": "Der Lauf beginnt mit {v} Münzen.",
  "campaign.reward.lehen": "Lehen",
  "campaign.reward.lehen.text": "Dein Baufeld hat {v} Zellen mehr Platz.",
  "campaign.reward.fahnenrecht": "Fahnenrecht",
  "campaign.reward.fahnenrecht.text": "Du hast in jeder Aufstellphase {v} Energie mehr.",
  "campaign.reward.standhaftigkeit": "Standhaftigkeit",
  "campaign.reward.standhaftigkeit.text": "Deine Serie überlebt {v} Niederlagen je Durchlauf.",
  "campaign.reward.losentscheid": "Losentscheid",
  "campaign.reward.losentscheid.text": "Stiche, die du um höchstens {v} verlierst, zählen als Sieg.",
  "campaign.reward.lueckenschluss": "Lückenschluss",
  "campaign.reward.lueckenschluss.text": "In jeder Formation dürfen {v} Karten nicht passen.",
  "campaign.reward.fuersprache": "Fürsprache",
  "campaign.reward.fuersprache.text": "Die Schwelle des nächsten Laufs sinkt um {v} %.",
  "campaign.reward.doppelwahl": "Doppelwahl",
  "campaign.reward.doppelwahl.text": "Nach einem erfüllten Auftrag wählst du zwei Beutestücke statt einem.",

  "campaign.axis.streak": "Serie",
  "campaign.axis.streak.mult": "Serien-Multiplikator",
  "campaign.axis.perk": "Perks",
  "campaign.axis.perk.mult": "Perk-Multiplikator",
  "campaign.axis.form": "Formation",
  "campaign.axis.form.mult": "Formations-Multiplikator",
  "campaign.axis.core": "Formationskern",
  "campaign.axis.core.mult": "Formationskern-Multiplikator",
  "campaign.axis.afterglow": "Nachhall",
  "campaign.axis.afterglow.mult": "Nachhall-Multiplikator",
  "campaign.axis.architect": "Gebäude",
  "campaign.axis.architect.mult": "Gebäude-Multiplikator",
  "campaign.axis.crit": "Crit",
  "campaign.axis.crit.mult": "Crit-Multiplikator",
  "campaign.axis.fire": "Feuer",
  "campaign.axis.fire.mult": "Feuer-Multiplikator",
  "campaign.axis.plant": "Pflanze",
  "campaign.axis.plant.mult": "Pflanzen-Multiplikator",
