...
export default {
  ...
  "hint.e1.body": "Dein erster Sieg: {win} Basispunkte. Serie, Crits, Formationen und Gebäude legen sich als Faktoren darauf.",
  "hint.e2.body": "Gleichstand: Niemand punktet. Nur Siege zahlen.",
  "hint.e3.body": "Serie {n}: Dein Serien-Faktor steht auf ×{mult}. Eine Niederlage setzt ihn zurück.",
  ...
  "hint.e6.body": "Formation {name}: Diese Karte zählt ×{mult}. Muster zählen nur innerhalb eines Segments.",
  "hint.e7.body": "Meilenstein erreicht — das bringt dir Stichpunkte für den Upgrade-Baum nach dem Lauf.",
  "hint.e8.body": "Dein Lauf zählt: Stichpunkte für den Upgrade-Baum, Deckpunkte für die Werkstatt. Alles Weitere findest du jederzeit im Tutorial.",
  ...
  "hint.u2.body": "Die Panels unter dem Spielfeld zeigen, woraus dein Score entsteht — jeder Faktor einzeln.",
  ...
  "hint.badge.reason": "Deine Crits füllen die Leiste — ist sie voll, ionisiert er Karten, und die bringen mehr Score und Crit-Chance.",
  ...
  "hint.sa2.body": "Bau einen Distrikt: Setz ein Gebäude derselben Kategorie — gleiche Farbe — neben dein erstes. Solche Nachbarn verstärken sich.",
