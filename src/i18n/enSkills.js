...
export default {
  ...
  "ability.SK_LIGHTNING_13.desc": "When you win with a card that stands in a formation, every ionized card in that formation grants +2% crit chance on the trick. Uncommon +3%, Rare +4%, Epic +6%, and the card with the fewest stacks in that formation gains +1 stack.",
