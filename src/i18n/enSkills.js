...
▸ Once ~${pct(C.ION_SAT_BREADTH_FRAC)}% of the cards are ionized: all cards +${C.ION_SATURATION_VALUE} value.`,
  ...
  "ability.SK_LIGHTNING_12.desc": "When an ionized card wins, an ionization stack preferentially jumps to a card that is not ionized yet (0 stacks) and pushes breadth towards full ionization. If there is none, it goes to the next card that is not yet full.",
