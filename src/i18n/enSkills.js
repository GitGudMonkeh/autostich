...
export default {
  ...
  "ability.SK_ICE_11.desc": `When a glacier bursts, it drags the mass of adjacent glaciers into its burst: their cells drop to zero, their mass counts towards its own.`,
