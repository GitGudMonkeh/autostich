...
export default {
  ...
  "ability.SK_ICE_03.desc": `Every cycle, unfrozen cells collect snow in their ground reserve: +1 at 2 cells' distance from the nearest glacier, +2 from 3. The 8 cells directly around a glacier stay empty. If a glacier later freezes here, the reserve refills it at the start of the cycle.`,
  "ability.SK_ICE_04.name": "Compaction",
  "ability.SK_ICE_04.desc": `If a building raises the combat value of a glacier card, that bonus is not played out but converted into mass instead: +0.25 mass per point. Score buildings are untouched.`,
  ...
  "ability.SK_ICE_10.desc": `Higher mass thresholds burst more steeply: force ×1.6 instead of ×1.5 at the 2nd threshold, ×2.6 instead of ×2.2 at the 3rd.`,
  ...
  "ability.SK_ICE_13.desc": `A glacier bursts at 9 mass already, instead of ${num(G_THRESHOLDS[G_THRESHOLDS.length - 1])}.`,
  ...
  "ability.SK_ICE_16.desc": `When a glacier bursts, its non-glacier neighbours get +2 trick value in the next cycle. With ice bridge, this applies to the 8-neighbourhood.`,
