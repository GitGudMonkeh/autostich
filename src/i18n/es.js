...
export default {
  ...
  "hint.e1.body": "Tu primera victoria: {win} puntos base. Racha, críticos, formaciones y edificios se apilan encima como factores.",
  "hint.e2.body": "Empate: nadie puntúa. Solo las victorias pagan.",
  "hint.e3.body": "Racha {n}: tu factor de racha está en ×{mult}. Una derrota lo reinicia.",
  ...
  "hint.e6.body": "Formación {name}: esta carta cuenta ×{mult}. Los patrones solo cuentan dentro de un segmento.",
  "hint.e7.body": "Hito alcanzado — eso te da Puntos de baza para el árbol de mejoras después de la partida.",
  "hint.e8.body": "Tu partida cuenta: Puntos de baza para el árbol de mejoras, puntos de mazo para el taller. Todo lo demás está en el tutorial, cuando quieras.",
  ...
  "hint.u2.body": "Los paneles bajo el campo de juego muestran de qué se compone tu puntuación — cada factor por separado.",
  ...
  "hint.badge.reason": "Tus críticos llenan la barra — cuando está llena, ioniza cartas, y esas dan más puntuación y probabilidad de crítico.",
  ...
  "hint.sa2.body": "Construye un distrito: coloca un edificio de la misma categoría — el mismo color — junto al primero. Esos vecinos se refuerzan.",
  ...
  "tut.architekt.hauptaktion.1": "Se construye en cuanto tocas. El sitio lo buscas después, y mover y girar no cuestan nada.",
  "tut.architekt.regeln.title": "Las reglas en corto",
  "tut.architekt.regeln.0": "La fase de construcción aparece {nShop} veces por partida, la primera en el ciclo {firstShop}, siempre justo después de la fase de orden. · Cada fase te da una acción principal: construir o mejorar. · Después puedes mover y girar tantas veces como quieras. Eso no cuesta nada. · Puedes cubrir {cover} de las {cards} celdas, y hasta {coverMax} con el árbol de mejoras.",
  "tut.architekt.regeln.1": "Una acción principal por fase. Mover y girar son gratis.",
  ...
  "tut.architekt.hauptaktion.title": "Tu acción principal",
  ...
  "tut.architekt.wasist.0": "Después de cada fase de orden puedes colocar un edificio en tu tablero. El tablero son tus {cards} posiciones de carta, {rows} filas de {segment}. Un edificio cubre celdas y refuerza la carta que juega ahí.",
  "tut.architekt.wasist.1": "Toca una parte de la pantalla.",
  "tut.architekt.wasist.2": "Los edificios se quedan. Lo que está puesto una vez actúa en todos los ciclos siguientes.",
  "tut.architekt.wasist.title": "Qué es el Arquitecto",
  "tut.architekt.wohin.0": "Si cubres una fila, una columna o una diagonal enteras, aparece una estructura. Cada carta que gane ahí da más puntuación. Si hay edificios de la misma categoría pegados, encima viene un distrito.",
  "tut.architekt.wohin.1": "La celda marcada es siempre la misma, para que solo la colocación de los edificios marque la diferencia.",
  "tut.architekt.wohin.2": "La estructura solo cuenta cuando una línea está cerrada del todo, con los edificios que sea. Para el distrito basta con que categorías iguales se toquen.",
  "tut.architekt.wohin.title": "Dónde construyes",
  "tut.aufstellung.brett.0": "Gana las cinco. Tienes {energy} de energía.",
  "tut.aufstellung.brett.1": "Deshacer quita el último intercambio. Restablecer vuelve al inicio. Ninguno cuesta energía.",
  "tut.aufstellung.brett.title": "El tablero",
  "tut.aufstellung.formationen.0": "Encuentra las cuatro. Toca dos cartas para intercambiar.",
  ...
  "tut.aufstellung.karte.0": "Toca una carta.",
  "tut.aufstellung.karte.1": "Una repetición ya paga desde la segunda carta. El bloque de palo, la escalera y la alternancia llevan su marca desde la segunda pero solo pagan desde la tercera.",
  "tut.aufstellung.karte.title": "Qué pone en una carta",
  "tut.aufstellung.phase.0": "Entre dos ciclos puedes cambiar el orden de tus {cards} cartas. Intercambias dos cartas tantas veces como energía tengas.",
  "tut.aufstellung.phase.1": "Cuándo entra cada carta. Tus cartas se juegan en orden. Si mueves una, se juega en otro punto del ciclo. · Qué formaciones aparecen. Las cartas que quedan juntas forman formaciones y suben la puntuación.",
  "tut.aufstellung.phase.2": "Cada intercambio cuesta una energía. Al principio tienes {energy} por fase y llegas hasta {energyMax} con el árbol de mejoras. · La fase de orden aparece {nForm} veces por partida. · Tu orden se mantiene hasta que vuelvas a cambiarlo.",
  "tut.aufstellung.phase.3": "El rival vuelve a barajar antes de cada ciclo. Tú no.",
  "tut.aufstellung.phase.title": "La fase de orden",
  "tut.aufstellung.stapeln.0": "Pon una carta en dos formaciones a la vez.",
  "tut.aufstellung.stapeln.1": "Si ganas la baza, el multiplicador cuenta. Si la pierdes, no cuenta nada, por alto que fuera.",
  "tut.aufstellung.stapeln.title": "Superpuestas",
  "tut.aufstellung.sub": "Orden de las cartas, energía, formaciones, segmentos.",
  "tut.aufstellung.title": "Fase de orden",
  "tut.back": "Atrás",
  "tut.blitz.karte.0": "Ponle marcas y mira cómo cambia la carta.",
  ...
  "tut.blitz.tipps.1": "Lo que hace cada habilidad está en el glosario.",
  "tut.blitz.tipps.title": "Consejos para empezar",
  "tut.blitz.title": "Rayo",
  "tut.blitz.wasist.0": "Un crítico multiplica la puntuación de una baza. En todos los demás arquetipos es azar. Rayo se lo fabrica él mismo.",
  "tut.blitz.wasist.1": "La primera habilidad de Rayo da un {critFirst} % de probabilidad de crítico, y cada una más un {critPerSkill} %. Además {critMultPerSkill}× de multiplicador de crítico por habilidad, sobre la base de {critMult}×. Eso corre sin que hagas nada; lo que hacen las habilidades sueltas viene encima.",
  "tut.blitz.wasist.1.label": "Pasiva",
  "tut.blitz.wasist.2": "Crítico. El rendimiento. La probabilidad y el multiplicador salen los dos de tus habilidades de Rayo. · Carga. El combustible, {charge} como mucho. Un crítico la da, y una victoria también. · Ionización. Marcas permanentes en tus cartas. Vuelven a subir la probabilidad de crítico.",
  "tut.blitz.wasist.3": "Los tres se sostienen entre sí: el crítico hace carga, la carga hace ionización, la ionización vuelve a hacer crítico. Eso es todo el arquetipo.",
  "tut.blitz.wasist.title": "Qué es Rayo",
  "tut.d.all": "Todas",
  "tut.d.blade": "Hoja",
  "tut.d.block": "Bloque",
  ...
  "tut.d.yes": "sí",
  "tut.d.zeile": "Fila",
  "tut.danach.baum.0": "Con Puntos de baza compras nodos. Lo que se compra una vez vale en todas las partidas futuras. Dos ramas: General y Mazos.",
  "tut.danach.baum.1": "Cambia entre las ramas.",
  "tut.danach.baum.2": "El árbol es la razón por la que una segunda partida transcurre distinta de la primera. La energía y el terreno de obra cuelgan de aquí, y las dos ya las has visto en lecciones anteriores.",
  "tut.danach.baum.title": "El árbol de mejoras",
  "tut.danach.endscreen.0": "Después del último ciclo la partida termina. La pantalla final muestra lo que ha dado y lo que recibes por ello.",
  "tut.danach.endscreen.1": "Toca una parte de la pantalla.",
  "tut.danach.endscreen.2": "Tu mejor partida corre en la siguiente como fantasma. La barra de estado muestra en todo momento si vas por delante o por detrás de ella.",
  ...
  "tut.danach.rangliste.0": "Una vez por semana hay una partida para todos con la misma imagen de salida. La misma semilla, las mismas ofertas, el mismo orden.",
  "tut.danach.rangliste.1": "Como todos reciben las mismas cartas y las mismas ofertas, lo único que decide es qué haces con ellas. Tu árbol de mejoras cuenta; tu suerte no.",
  "tut.danach.rangliste.1.label": "Lo que cuenta ahí",
  "tut.danach.rangliste.2": "Una partida clasificatoria paga los mismos puntos que una normal. Así que no pierdes nada por jugarla.",
  "tut.danach.rangliste.title": "La partida clasificatoria",
  "tut.danach.sub": "Pantalla final, puntos, árbol de mejoras, clasificatoria.",
  "tut.danach.title": "Después de la partida",
  "tut.eis.feld.0": "Toca casillas para congelar glaciares ahí. Tocar otra vez descongela.",
  "tut.eis.feld.1": "Vecinos y formaciones son dos cosas distintas. Cada glaciar adyacente cuenta por sí solo, esté como esté. Una formación solo se da cuando la forma está completa, y entonces añade otro factor encima.",
  "tut.eis.feld.title": "El campo de glaciares",
  "tut.eis.karte.0": "Deja subir la masa y mira cuándo rompe.",
  "tut.eis.karte.1": "La escarcha de la carta salta en los tres umbrales, no crece de forma uniforme. Así ves desde fuera qué nivel ha alcanzado un glaciar.",
  "tut.eis.karte.title": "La carta",
  ...
  "tut.eis.tipps.1": "Lo que hace cada habilidad está en el glosario.",
  "tut.eis.tipps.title": "Consejos para empezar",
  "tut.eis.title": "Hielo",
  "tut.eis.wasist.0": "Un glaciar es una carta congelada en su posición. Acumula masa en cada ciclo. Con {massBurst} se rompe, paga puntuación y vuelve a empezar desde cero.",
  "tut.eis.wasist.1": "Cada habilidad de Hielo congela una de tus cartas, también un cambio con las ranuras de habilidad llenas. A partir de ahí ya no puede reordenarse nunca. Con {iceDeclineMin} habilidades de Hielo en mano, incluso rechazar una oferta congela un glaciar.",
  "tut.eis.wasist.1.label": "Pasiva",
  "tut.eis.wasist.2": "Esa es la decisión que pide Hielo. Una carta congelada no puedes reordenarla nunca más. Renuncias a movilidad y a cambio recibes masa.",
  "tut.eis.wasist.3": "Glaciar. Una carta congelada. Se queda en su posición el resto de la partida. · Masa. Un número en el glaciar. Cada ciclo da {iceTick}, y una victoria otro {iceWin}. · Rotura. Con {massBurst} de masa el glaciar se rompe, paga puntuación y vuelve a empezar desde cero.",
  "tut.eis.wasist.4": "Hielo es el único mazo en el que cuenta dónde están tus cartas, no solo en qué orden.",
  "tut.eis.wasist.title": "Qué es Hielo",
  ...
  "tut.feuer.feld.0": "Sube el calor y mira qué se enciende.",
  "tut.feuer.feld.1": "Por encima del **{dividendCap} %** el dividendo ya no añade nada. Aun así compensa seguir calentando: con **{gkSkill}** todas tus cartas se vuelven +{glowV2} más fuertes al {glowT2} % y +{glowV3} al {glowT3} %. Y a partir del {conflagAt} %, **{fbSkill}** puede convertir toda la barra en un solo golpe.",
  "tut.feuer.feld.title": "La barra de calor",
  "tut.feuer.karte.0": "Convertir una derrota en una victoria clara.",
  "tut.feuer.karte.1": "Las dos cosas amplían tu ventaja, y la ventaja es justo con lo que cuenta Fuego.",
  "tut.feuer.schmiede.title": "La forja",
  "tut.feuer.schmiede.0": "Así la ceniza se vuelve valor permanente.",
  "tut.feuer.schmiede.1": "Las dos cosas amplían tu ventaja. El valor forjado se queda en el mazo **de forma permanente**, incluso tras un cambio de habilidad. Las marcas de fuego **no se acumulan**: una nueva sustituye a la vieja.",
  "tut.feuer.karte.title": "Las cartas",
  ...
  "tut.feuer.tipps.1": "Lo que hace cada habilidad está en el glosario.",
  "tut.feuer.tipps.title": "Consejos para empezar",
  "tut.feuer.title": "Fuego",
  "tut.feuer.wasist.0": "Fuego no premia ganar, sino ganar con claridad. La moneda es el margen: cuánto queda tu carta por encima de la del rival.",
  "tut.feuer.wasist.1": "A partir de {heatMinMargin} de margen, cada victoria calienta la barra y paga puntuación de fuego enseguida, y las dos cosas crecen con el margen. Cada habilidad de Fuego más da {firePerSkill} de puntuación de fuego por punto de margen. Las derrotas enfrían, como mucho un {heatLossMax} %.",
  "tut.feuer.wasist.1.label": "Pasiva",
  "tut.feuer.wasist.2": "Margen. No si ganas, sino con cuánta claridad. · Calor. Una barra de cero a {heatMax}. Su nivel decide qué habilidades actúan en ese momento. · Ceniza. De los incendios en el rival. La forja la convierte en valor de carta permanente.",
  "tut.feuer.wasist.3": "Más margen significa más calor, más calor significa cartas más fuertes, y cartas más fuertes significan más margen.",
  "tut.feuer.wasist.title": "Qué es Fuego",
  "tut.fortgeschritten.glut.0": "Hay combinaciones en las que una parte hace más grande a la otra. Dos de ellas, y ambas siguen la misma idea. Aquí la primera.",
  "tut.fortgeschritten.glut.1": "La duplicación vale solo para el dividendo de brasas. Sobre el resto de la puntuación esa misma estructura actúa con su factor normal.",
  "tut.fortgeschritten.glut.title": "Brasas sobre geometría",
  "tut.fortgeschritten.klinge.title": "Hoja incandescente y Rayo",
  "tut.fortgeschritten.klinge.0": "La segunda combinación, con la misma idea.",
  "tut.fortgeschritten.klinge.1": "Hay un pero: la hoja incandescente solo cuenta desde su segundo nivel si tu última victoria tuvo {glowM2} de margen, y desde el tercero {glowM3}. Una derrota lo pone a cero.",
  "tut.fortgeschritten.klinge.2": "Las dos combinaciones tienen la misma forma: algo hace tus bazas más grandes, y otra cosa multiplica justo eso.",
  "tut.fortgeschritten.laenge.0": "Lo que paga una formación depende de su longitud. A partir de la tercera carta cada una más añade algo, y sin tope.",
  "tut.fortgeschritten.laenge.1": "Se muestra el factor que lleva la última carta de la formación — medido con el reconocimiento real, no calculado.",
  "tut.fortgeschritten.laenge.2": "La repetición crece más rápido: a partir de la cuarta carta añade {wiedStep} por cada una más, y las otras tres {eskStep}. A cambio es la más difícil de construir.",
  "tut.fortgeschritten.laenge.3": "Dos formaciones en la misma carta se multiplican, y encima viene un bono. Una carta que está en dos a la vez vale por eso mucho más que dos cartas con una cada una.",
  "tut.fortgeschritten.laenge.title": "Las formaciones largas pagan más",
  "tut.fortgeschritten.segmente.0": "Abre los límites.",
  "tut.fortgeschritten.segmente.1": "Dos maneras de abrir un límite: la ventaja {segWork} y el edificio {pillar}. Un límite abierto no cambia ninguna carta — solo deja que la formación siga.",
  "tut.fortgeschritten.segmente.title": "Abrir los límites de segmento",
  "tut.fortgeschritten.sub": "Formaciones largas, límites abiertos, dos construcciones.",
  "tut.fortgeschritten.title": "Avanzado",
  "tut.g.best.name": "Mejores marcas",
  "tut.g.best.text": "Mejor racha, mejor baza y más golpes críticos de esta partida.",
  "tut.g.meilen.name": "Los hitos",
  "tut.g.meilen.text": "Cuántas marcas ha alcanzado tu puntuación y dónde está la siguiente.",
  "tut.g.punkte.name": "Puntos de baza y puntos de mazo",
  "tut.g.punkte.text": "Lo que la partida te aporta para el árbol de mejoras y para el taller.",
  "tut.g.score.name": "La puntuación de la partida",
  "tut.g.score.text": "Arriba del todo el número, debajo la distancia a tu récord y los datos clave de la partida.",
  "tut.grundlagen.anzeigen.0": "Toca cada elemento.",
  "tut.grundlagen.anzeigen.1": "El origen de la puntuación abre el desglose de la partida. También está en la pantalla final.",
  "tut.grundlagen.anzeigen.title": "La pantalla de partida",
  "tut.grundlagen.herkunft.0": "Toca una línea.",
  "tut.grundlagen.herkunft.1": "Cada línea viene de una fase distinta. La racha de la propia partida, la formación de la fase de orden, el crítico y los puntos base de las ventajas y las habilidades.",
  "tut.grundlagen.herkunft.title": "De dónde sale tu puntuación",
  "tut.grundlagen.score.0": "Toca una línea y mira el cálculo que hay detrás.",
  "tut.grundlagen.score.1": "Coge las dos cosas. Los puntos base y los factores se refuerzan entre sí.",
  "tut.grundlagen.formel.title": "Así calcula el juego",
  "tut.grundlagen.formel.0": "({base} + puntuación directa) × racha × ventajas × formación × crítico. En ese orden, y el crítico siempre al final. La puntuación directa y las ventajas salen de tus elecciones y llegan más tarde. Los otros tres están abajo, por separado y juntos.",
  "tut.grundlagen.formel.1.label": "De dónde salen los factores",
  "tut.grundlagen.formel.1": "De las ventajas y las habilidades. Cada elección sube o bien los puntos base o bien un factor, y lo hace de forma permanente. Actúa en cada victoria posterior, o sea en la puntuación de toda la partida.",
  "tut.grundlagen.formel.2.label": "Qué es un crítico",
  "tut.grundlagen.formel.2": "Una victoria que cuenta más: la base por {critMult}. Ocurre al azar. Tu probabilidad de crítico empieza en cero y sale de las ventajas y las habilidades.",
  "tut.grundlagen.formel.3": "El crítico va siempre al final. La puntuación directa sube los puntos base antes de que se multiplique nada.",
  "tut.grundlagen.score.title": "La puntuación",
  "tut.grundlagen.serie.0": "Reordena. Gana las cinco.",
  "tut.grundlagen.serie.1": "Una derrota pone la racha a cero. El orden decide.",
  "tut.grundlagen.serie.title": "La racha",
  "tut.grundlagen.stich.0": "Cuatro bazas. Mira.",
  "tut.grundlagen.stich.1": "Un empate no paga nada. Solo paga una victoria.",
  "tut.grundlagen.stich.title": "La baza",
  "tut.grundlagen.sub": "Qué es Autobaza, cómo transcurre una baza, de dónde sale tu puntuación.",
  ...
  "tut.sz.los": "Jugar",
  "tut.sz.nochmal": "Otra vez",
  "tut.sz.gegenAB": "{a} contra {b}",
  "tut.sz.sieg": "Victoria",
  "tut.sz.niederlage": "Derrota",
  "tut.sz.kampfwert": "Valor de combate",
  "tut.sz.a.hoeher": "Gana el valor más alto.",
  "tut.sz.b.badge": "⚔ +{n} baza",
  "tut.sz.b.eq1": "Valor de carta **{v}**. Está en la carta de forma permanente.",
  "tut.sz.b.eq2": "Valor de baza **{v}**. Solo vale para esta baza.",
  "tut.sz.b.eq3": "Valor de combate **{v}**. Los dos juntos. La carta muestra exactamente este número, y solo él decide la baza.",
  "tut.sz.c.opp": "Rival, boca arriba",
  "tut.sz.c.you": "Tú. Toca dos para intercambiar",
  "tut.sz.c.say0": "Cada victoria seguida sube el multiplicador un {p} %.",
  "tut.sz.c.serieN": "Racha {n}",
  "tut.sz.c.serieM": "Racha {n} · ×{m}",
  "tut.sz.c.perfekt": "{tot} en vez de {basis} sin racha. El multiplicador sigue creciendo, hasta ×{cap}.",
  "tut.sz.c.fast": "{tot} puntos. Sin interrupción serían {max}.",
  "tut.sz.d.basisLabel": "Tus puntos base. Toca para cambiar.",
  "tut.sz.d.chipOhne": "Sin puntuación directa",
  "tut.sz.d.chipMit": "Con ventaja",
  "tut.sz.d.hintFlat": "Una **puntuación directa** sube los puntos base **antes** de que se multiplique nada. Ejemplo: la ventaja «{perk}» da +{n} cuando tu valor ganador es {w} o más.",
  "tut.sz.d.vglLabel": "La misma baza, con distintos factores",
  "tut.sz.d.eqLabel": "El cálculo detrás",
  "tut.sz.d.f0": "Solo puntos base",
  "tut.sz.d.f1": "Solo racha",
  "tut.sz.d.f2": "Solo formación",
  "tut.sz.d.f3": "Solo crítico",
  "tut.sz.d.f4": "Racha y formación",
  "tut.sz.d.f5": "Los tres",
  "tut.sz.d.ohneFaktor": "sin factor",
  "tut.sz.d.eqBasis": "Puntos base **{v}**",
  "tut.sz.d.eqBasisFlat": "Puntos base {w} + {f} de puntuación directa = **{v}**",
  "tut.sz.d.eqStep": "× {f} {nm} = **{v}**",
  "tut.sz.d.eqKein": "Sin factor no hay multiplicador.",
  "tut.sz.d.eqFach": "**{x} veces** los puntos base",
  "tut.sz.d.merk": "**{f} de puntuación directa se convierten en {g}.** Están en los puntos base y todo lo posterior los multiplica, aquí por {x}.",
  "tut.sz.d.say": "Cada factor multiplica el resultado. Dos juntos hacen más que cualquiera por separado.",
  "tut.sz.e.tap": "Toca un elemento.",
  "tut.sz.e.durchl": "Ciclo",
  "tut.sz.e.msWort": "Hitos",
  "tut.sz.e.mult": "Multiplicadores",
  "tut.sz.e.critChance": "Prob. de crítico",
  "tut.sz.e.critMult": "Mult. de crítico",
  "tut.sz.e.verl": "Derrotas",
  "tut.sz.e.quote": "Tasa",
  "tut.sz.e.herk": "Origen de la puntuación",
  "tut.sz.e.bar.nm": "Barra superior",
  "tut.sz.e.bar.txt": "Puntuación, racha, ciclo. Siempre visible.",
  "tut.sz.e.tempo.nm": "Velocidad y crónica",
  "tut.sz.e.tempo.txt": "Pausa, ×2, ×4, MAX. A la derecha la crónica. Ahí está cada baza jugada para consultarla.",
  "tut.sz.e.ms.nm": "Hitos",
  "tut.sz.e.ms.txt": "Marcas de puntuación de toda la partida. Cada marca alcanzada paga Puntos de baza al final.",
  "tut.sz.e.ms.tip": "Los hitos cuentan la puntuación de toda la partida, no la de un ciclo.",
  "tut.sz.e.board.nm": "El tablero",
  "tut.sz.e.board.txt": "Tu carta contra la del rival. Aquí se juega la baza.",
  "tut.sz.e.bars.nm": "Barra de facción",
  "tut.sz.e.bars.txt": "El recurso de tu arquetipo. Aquí es calor.",
  "tut.sz.e.bars.tip": "Lo que hacen los recursos llega en la sección de los arquetipos.",
  "tut.sz.e.rail.nm": "De dónde sale tu puntuación",
  "tut.sz.e.rail.txt": "Tus multiplicadores, tu tasa, y el origen de la puntuación para desplegar.",
  "tut.sz.f.nachLabel": "Puntuación tras {n} ciclos",
  "tut.sz.f.zeile": "Cada línea es un factor.",
  "tut.sz.f.why.siege": "La puntuación base por cada baza ganada. Todos los factores la multiplican.",
  "tut.sz.f.why.serie": "Cinco victorias seguidas, un {p} % cada una. Una derrota pone a cero.",
  "tut.sz.f.why.form": "Formaciones en tu orden de cartas. Vienen de la fase de orden.",
  "tut.sz.f.why.crit": "Golpe crítico, base ×{m}. La probabilidad viene de ventajas y habilidades.",
  "tut.sz.f.ketteLabel": "La cadena, en este orden",
  "tut.sz.f.eq1": "{n} victorias × **{win}** = **{v}**",
  "tut.sz.f.eqStep": "× {nm} {f} = **{v}**",
  "tut.sz.f.hint": "El crítico va siempre al final. Si entra puntuación directa de las ventajas, sube los {win} antes de que se multiplique nada.",
  "tut.sz.neu": "De nuevo",
  "tut.sz.und": "y",
  "tut.sz.g.say0": "Cada intercambio cuesta una energía. Deshacer la devuelve.",
  "tut.sz.g.sayNoEnergy": "No queda energía. Juega o deshaz un intercambio.",
  "tut.sz.g.sayLeft": "Quedan {n} de energía.",
  "tut.sz.g.sayEmpty": "Energía agotada. Deshacer la devuelve.",
  "tut.sz.g.sayUndo": "Intercambio deshecho. Energía devuelta.",
  "tut.sz.g.sayReset": "De vuelta al inicio. Energía completa.",
  "tut.sz.g.sayWin": "Las cinco ganadas, y el orden forma una {form}.",
  "tut.sz.g.sayLose": "{w} de 5. Deshaz y ordena de otra manera.",
  "tut.sz.g.wins": "{n} victorias",
  "tut.sz.g.winsTie": "{n} victorias, {t} empates",
  "tut.sz.g.formLabel": "Formaciones",
  "tut.sz.g.besser": "mejor",
  "tut.sz.g.schlechter": "peor",
  "tut.sz.g.gleich": "igual",
  "tut.sz.g.hint": "Se muestra el multiplicador de formación. Solo cuenta para las bazas que ganas.",
  "tut.sz.h.segLabel": "Segmento {s}, posiciones {a} a {b}",
  "tut.sz.h.tap": "Toca una carta.",
  "tut.sz.h.pos": "Posición {n}",
  "tut.sz.h.wert": "Valor {v}. Está en {namen}.",
  "tut.sz.h.wertKeine": "Valor {v}. No está en ninguna formación.",
  "tut.sz.h.eq1": "En grande, el **valor**.",
  "tut.sz.h.eq2": "Abajo, las **siglas** de las formaciones: {liste}.",
  "tut.sz.h.eq3": "Arriba a la derecha su **multiplicador**, solo para esta posición.",
  "tut.sz.h.deckLabel": "Todo tu mazo, {n} posiciones",
  "tut.sz.h.hint": "Cada {segment} cartas forman un segmento, y {segments} segmentos dan las {cards} cartas de un ciclo. Una formación solo vale hasta el final de su segmento. Algunas ventajas y edificios abren los límites de segmento, y entonces sigue más allá.",
  "tut.sz.i.erkannt": "Reconocida por la misma función que calcula en la partida.",
  "tut.sz.i.sortier": "Reordena hasta que se reconozca algo.",
  "tut.sz.i.gefunden": "Encontradas",
  "tut.sz.i.wie": "Cómo se forman",
  "tut.sz.i.regeln": "Repetición: dos o más valores iguales seguidos. · Bloque de palo: tres o más cartas del mismo palo seguidas. · Escalera: tres o más valores que suben o bajan sin interrupción, con un paso de {treppeStep} como mucho. · Alternancia: arriba, abajo, arriba. Cada distancia entre vecinas de {wechselDiff} como mínimo.",
  "tut.sz.i.say0": "Una formación en el orden multiplica la puntuación de cada baza dentro de ella.",
  "tut.sz.i.count": "{n} de {total} encontradas.",
  "tut.sz.i.alle": "Las cuatro encontradas.",
  "tut.sz.j.txt0": "Pon una carta en dos formaciones a la vez.",
  "tut.sz.j.txt2": "Dos formaciones en una carta. Los factores se multiplican.",
  "tut.sz.j.zahlt": "Una baza ganada paga",
  "tut.sz.j.say0": "Dos formaciones en una carta multiplican sus factores.",
  "tut.sz.j.say2": "Dos formaciones dan ×{m}.",
  "tut.sz.n.merk1": "**Sustituir, no acumular.** Si coges el nivel II, el nivel I desaparece. Después tienes +{b} en vez de +{a}.",
  "tut.sz.n.text1": "Los niveles más altos son más fuertes y se ofrecen con menos frecuencia. El nivel IV cierra una familia, y después ya no vuelve a salir.",
  "tut.sz.n.text2": "Las ventajas legendarias están fuera de los niveles: sin familia, sin mejora, marco dorado. Una sola puede decidir hacia dónde va tu partida. Hay {n}.",
  "tut.sz.n.merk2": "**Primero desbloquear.** Sin el nodo «{node}» del árbol de mejoras nunca te ofrecerán una. Cuesta {sp} PB y está detrás de la rareza {tier4}.",
  ...
  "tut.sz.fb.mein": "Tu carta, forjada",
  "tut.sz.fb.gegner": "Carta rival, marcada a fuego",
  "tut.sz.fb.wie0": "Sin marcas.",
  "tut.sz.fb.wie1": "Una forja, una marca de fuego.",
  "tut.sz.fb.wie2": "Dos forjas, una marca de fuego.",
  "tut.sz.fb.wie3": "Tres forjas, el máximo. Marca con {ofen}.",
  "tut.sz.fb.nmKnapp": "Victoria, pero demasiado justa",
  "tut.sz.fb.nmVor": "Ventaja {v}",
  "tut.sz.fb.txtVerlust": "Un {a} contra un {b}. Pierdes la baza.",
  "tut.sz.fb.txtKnapp": "Ganas, pero con solo {v} de ventaja. Fuego solo paga a partir de {min}, así que aquí nada.",
  "tut.sz.fb.txtVor": "{v} de ventaja: {score} de puntuación de fuego y +{heiz} % de calor.",
  "tut.sz.fb.ketteLabel": "Cómo funciona la forja",
  "tut.sz.fb.k1b": "Marca",
  "tut.sz.fb.k2b": "Ceniza",
  "tut.sz.fb.k3b": "Forjar",
  "tut.sz.fb.k1": "Cada victoria marca una carta rival y da **+{n} de ceniza**.",
  "tut.sz.fb.k2": "Al final de cada ciclo, cada **{c} de ceniza** se convierte en una forja.",
  "tut.sz.fb.k3": "La habilidad **{skill}** da a tu carta **más baja** **+{v}** de valor permanente. Después, otra carta es la más baja.",
  "tut.sz.fb.e1": "Tu carta forjada brilla desde dentro y lleva arriba a la derecha un yunque dorado con la cantidad.",
  "tut.sz.fb.e2": "La carta rival marcada se carboniza desde abajo, lleva su malus arriba a la izquierda y el signo de fuego abajo a la derecha.",
  "tut.sz.fc.skillsLabel": "Habilidades que dependen de tu calor",
  "tut.sz.fc.kalt": "Frío",
  "tut.sz.fc.voll": "Lleno",
  "tut.sz.fc.txt": "Puntuación directa en cada victoria de fuego. No se multiplica con racha, crítico ni formaciones.",
  "tut.sz.fc.s1": "**{gk} I.** Todas tus cartas +{v} de valor de baza.",
  "tut.sz.fc.s2": "**{ofen}.** Las marcas queman más hondo y dan más ceniza. {schmiede} cuesta un {r} % menos por forja.",
  "tut.sz.fc.s3": "**{gk} II.** +{v} de valor de baza. Necesita además una victoria con {m} de ventaja.",
  "tut.sz.fc.s4": "**{fb} armado.** La próxima victoria quema la barra hasta el {t} %.",
  "tut.sz.fc.s5": "**{gk} III.** +{v} de valor de baza. Necesita además una victoria con {m} de ventaja.",
  "tut.sz.fc.mUeber": "**Incandescencia.** {u} puntos de sobrecalentamiento dan +{plus} por ciento a toda tu puntuación de fuego. Se reduce de nuevo con cada baza.",
  "tut.sz.fc.mDeckel": "**Se alcanzó el tope.** A partir del {cap} % el dividendo ya no crece. Lo que queda más arriba hace más fuertes tus cartas o alimenta {fb}.",
  "tut.sz.fc.mWachs": "**El dividendo crece con cada punto.** {d} de puntuación por cada uno por ciento de calor, hasta el {cap} %.",
  "tut.sz.pb.bisLabel": "Hasta la madurez",
  "tut.sz.pb.reif": "madura",
  "tut.sz.pb.bisN": "{n} de {max}",
  "tut.sz.pb.wachsLabel": "Crecimiento",
  "tut.sz.pb.frisch": "Fresca",
  "tut.sz.pb.reifBtn": "Madura",
  "tut.sz.pb.vollBtn": "Llena",
  "tut.sz.pb.skillsLabel": "¿Qué habilidades tienes?",
  "tut.sz.pb.rein": "Solo habilidades de Planta",
  "tut.sz.pb.mix": "También una ajena",
  "tut.sz.pb.skillsHint": "Lo **rápido** que crece depende del número de tus habilidades de Planta: con una, un tercio del ritmo; ritmo pleno a partir de {ref}. Que además se vuelva **más valiosa** depende de que no haya ninguna habilidad ajena.",
  "tut.sz.pb.nmVoll": "Crecida del todo",
  "tut.sz.pb.nmReif": "Madura, o sea verde",
  "tut.sz.pb.nmSetzling": "Plantón",
  "tut.sz.pb.nmFrisch": "Fresca",
  "tut.sz.pb.txtMix": "Construcción mixta: la carta se vuelve verde, pero su valor se queda en {w}.",
  "tut.sz.pb.txtVoll": "Valor {cap}, el tope. Más crecimiento solo paga a través de los árboles legendarios.",
  "tut.sz.pb.txtReif": "Verde a partir de {g} de crecimiento. Por cada {pro} de crecimiento se ha vuelto {plus} más valiosa.",
  "tut.sz.pb.txtSetzling": "Crece, pero aún no está madura. Un plantón todavía no cuenta para el bloque de palo verde.",
  "tut.sz.pb.txtFrisch": "Aún sin crecimiento. Una carta corriente.",
  "tut.sz.pb.wert": "Valor {v}",
  "tut.sz.pb.hReif": "Madura. Cada {pro} de crecimiento más sube el valor en {plus}, hasta {cap}.",
  "tut.sz.pb.hReifMix": "Madura. El valor no sube porque hay una habilidad ajena en la construcción.",
  "tut.sz.pb.hWachs": "Una victoria de esta carta da hasta +{plus} de crecimiento.",
  "tut.sz.pb.e1": "El **número** pasa con el crecimiento del color de la carta al verde.",
  "tut.sz.pb.e2": "Abajo a la derecha corre un **anillo** mientras crece y aún no está madura.",
  "tut.sz.pb.e3": "A partir de {g} de crecimiento está **madura**: el anillo desaparece, la carta recibe un borde verde y el número brilla.",
  "tut.sz.pc.feldLabel": "Quince cartas de tu mazo",
  "tut.sz.pc.grau": "gris",
  "tut.sz.pc.nm": "{n} de {max} verdes",
  "tut.sz.pc.txtUeber": "{skill} está activa.",
  "tut.sz.pc.txtNoch": "Faltan {n} cartas para {skill}.",
  "tut.sz.pc.eqLabel": "Una victoria verde en el segmento 1",
  "tut.sz.pc.eqBlock": "× {fb} {f}{zusatz} = **{v}**",
  "tut.sz.pc.eqBlockAb": " (solo a partir de {min} verdes seguidas)",
  "tut.sz.pc.eqBluete": "+ {sk} {teil} = **{v}**",
  "tut.sz.pc.gruene": "{n} verdes",
  "tut.sz.pc.teilBraucht": "también necesita {min} verdes seguidas",
  "tut.sz.pc.eqGesamt": "La baza paga **{v}**",
  "tut.sz.pc.eqHint": "Suponiendo que tienes **{b}** y **{u}**. Los otros segmentos calculan igual.",
  "tut.sz.pc.merkUeber": "**{skill}.** El bloque de palo sube de ×{a} a ×{b} y la puntuación de flor cuenta doble.",
  "tut.sz.pc.merkCap": "**El bloque de palo verde paga ×{a}**, da igual cuántas cartas verdes haya seguidas. Con cualquier otro palo el factor crece con cada carta más.",
  "tut.sz.eb.nmBricht": "Rompe",
  "tut.sz.eb.nmFrisch": "Recién congelada",
  "tut.sz.eb.nmWaechst": "Aún creciendo",
  "tut.sz.eb.nmStufe": "Nivel de fuerza {n}",
  "tut.sz.eb.txtBricht": "Con {max} de masa el glaciar rompe, paga y vuelve a empezar.",
  "tut.sz.eb.txtFrisch": "Aún sin masa. Cada ciclo da +{a}, y una victoria otro +{b}.",
  "tut.sz.eb.txtWaechst": "Por debajo de {t1} de masa la rotura no tiene fuerza. No pagaría nada.",
  "tut.sz.eb.txtNoch": "Faltan {n} de masa para la rotura.",
  "tut.sz.eb.wucht": "Fuerza {w}",
  "tut.sz.eb.stufenLabel": "Tres niveles",
  "tut.sz.eb.sZeile": "Fuerza ×{m}",
  "tut.sz.eb.sBricht": ". Aquí rompe.",
  "tut.sz.ec.kern": "Una **formación de glaciares** es una forma cerrada de glaciares adyacentes. Cada rotura dentro se refuerza. Hay cuatro, y las que se superponen se acumulan.",
  "tut.sz.ec.brettLabel": "Tu tablero, {a} por {b}",
  "tut.sz.ec.leeren": "Vaciar",
  "tut.sz.ec.formenLabel": "Las cuatro formas",
  "tut.sz.ec.nmKein": "Sin glaciar",
  "tut.sz.ec.nmN": "{n} glaciares",
  "tut.sz.ec.txtTapFeld": "Toca una casilla.",
  "tut.sz.ec.txtTapGl": "Toca un glaciar para ver su rotura.",
  "tut.sz.ec.nb1": "{n} glaciar vecino",
  "tut.sz.ec.nbN": "{n} glaciares vecinos",
  "tut.sz.ec.keineForm": "sin forma",
  "tut.sz.ec.eqLabel": "La rotura del glaciar marcado",
  "tut.sz.ec.eqKein": "Aún no hay glaciar elegido.",
  "tut.sz.ec.eqGrund": "Masa {m} × fuerza {w} × {scale} = **{v}**",
  "tut.sz.ec.eqKask": "× Cascada {f} ({nb})",
  "tut.sz.ec.eqKoll": "× Colisión {f}",
  "tut.sz.ec.eqGeo": "× Geometría {f}{formen}",
  "tut.sz.ec.eqDeckel": "A partir de {cap} solo cuenta el {slope} %. De {roh} quedan {v}.",
  "tut.sz.ec.eqZahlt": "La rotura paga **{v}**",
  "tut.sz.ec.eqSieg": "Si gana su baza:",
  "tut.sz.ec.eqSiegStep": "× {nm} {f}",
  "tut.sz.ec.eqDann": "Entonces paga **{v}**",
  "tut.sz.ec.merkEin": "**Un glaciar solo rompe más débil.** Cada glaciar vecino da +{k} %, y las formas cerradas añaden otro factor encima.",
  "tut.sz.ec.merkForm": "**{formen}.** Las formas cerradas de glaciares refuerzan la rotura. {liste}. Las superpuestas se acumulan.",
  "tut.sz.ec.merkKeine": "**Aún sin forma.** {block} es 2 por 2, {kreuz} una casilla con sus cuatro vecinas, {linie} una fila o columna completa, {flaeche} 3 por 3.",
  "tut.sz.ec.merkZahlt": "**La rotura siempre paga.** Depende de la masa, no del resultado de la baza. Pero si la carta glaciar además gana su baza, racha, ventajas, formación y crítico multiplican encima.",
  "tut.sz.ec.hint1": "Todos los glaciares están aquí con masa completa {m}. El marcado es el último que tocaste.",
  "tut.sz.ec.hint2": "El **{scale}** es el escalador con el que Hielo calcula sus roturas. No tiene nada que ver con los {win} puntos base que da una baza ganada.",
  "tut.sz.ec.hint3": "Los factores de victoria son un ejemplo, los mismos que en los fundamentos. El tope aplica antes, la pila de victoria después.",
  "tut.sz.aa.ausLauf": "De la partida",
  "tut.sz.aa.neu": "Otro tablero",
  "tut.sz.aa.auge": "Arquitecto · fase de obra · ciclo {n}",
  "tut.sz.aa.titel": "El Arquitecto",
  "tut.sz.aa.boostLab": "Impulso de edificios",
  "tut.sz.aa.feldLab": "Terreno",
  "tut.sz.aa.belegt": "{n} ocupadas · {pct} %",
  "tut.sz.aa.pillBoost": "Impulso →0 %",
  "tut.sz.aa.pillKombis": "Combos",
  "tut.sz.aa.pillForm": "Formaciones",
  "tut.sz.aa.tap": "Toca una parte de la pantalla.",
  "tut.sz.aa.kopf.nm": "Cabecera",
  "tut.sz.aa.kopf.txt": "La fase de obra llega {shops} veces por partida, la primera en el ciclo {first}. Siempre sigue directamente a la fase de orden: primero colocas el tablero, luego pones el edificio.",
  "tut.sz.aa.boost.nm": "Impulso de edificios",
  "tut.sz.aa.boost.txt": "Lo que todos tus edificios juntos añaden de puntuación. Ese es el número que quieres hacer crecer al construir.",
  "tut.sz.aa.feld.nm": "Terreno",
  "tut.sz.aa.feld.txt": "Cuántas casillas quedan libres. El tablero tiene {cards}, al principio puedes construir en {cover}, hasta {coverMax} con el árbol de mejoras. Como el espacio escasea, el dónde se vuelve una decisión.",
  "tut.sz.aa.brett.nm": "El tablero",
  "tut.sz.aa.brett.txt": "Tus {cards} puestos de carta en ocho filas de cinco. Una fila es un segmento. Aquí están los edificios, aquí jugarán luego tus cartas.",
  "tut.sz.ab.ausschnitt": "Un recorte de tu tablero",
  "tut.sz.ab.nochmal": "Otra vez",
  "tut.sz.ab.wasBaust": "¿Qué construyes esta fase?",
  "tut.sz.ab.aufwerten": "Mejorar",
  "tut.sz.ab.aufwertenEff": "un edificio +1 nivel",
  "tut.sz.ab.nichtDrehbar": "no gira",
  "tut.sz.ab.moveLabel": "Mueve y gira cuantas veces quieras",
  "tut.sz.ab.hoch": "Arriba",
  "tut.sz.ab.runter": "Abajo",
  "tut.sz.ab.links": "Izquierda",
  "tut.sz.ab.rechts": "Derecha",
  "tut.sz.ab.drehen": "Girar",
  "tut.sz.ab.keinPlatz": "No hay sitio para girar. Mueve antes el edificio a un lugar más libre.",
  "tut.sz.ab.zug1": "Un movimiento hecho, y no costó nada.",
  "tut.sz.ab.zuege": "{n} movimientos hechos, y ninguno costó nada.",
  "tut.sz.ab.leuchtet": "El edificio recién puesto brilla. Llévalo adonde lo quieras.",
  "tut.sz.ab.nichtsNm": "Nada construido",
  "tut.sz.ab.nichtsTxt": "Elige un plano o mejora.",
  "tut.sz.ab.aufNm": "Mejorado: {nm} {stufe}",
  "tut.sz.ab.aufTxt": "Victoria +{neu} de puntuación en vez de +{alt}, en las mismas {felder} casillas.",
  "tut.sz.ab.bauNm": "Construido: {nm} {stufe}",
  "tut.sz.ab.bauTxt": "{eff}, en {felder} casillas.",
  "tut.sz.ax.zeileBtn": "Fila completa",
  "tut.sz.ax.spalteBtn": "Columna completa",
  "tut.sz.ax.diagBtn": "Diagonal",
  "tut.sz.ax.distriktBtn": "Distrito",
  "tut.sz.ax.keinBonus": "Sin bono",
  "tut.sz.ax.mitStruktur": "Estructura ×{f}",
  "tut.sz.ax.keineStruktur": "Sin estructura",
  "tut.sz.ax.mitDistrikt": "Distrito ×{f}",
  "tut.sz.ax.keinDistrikt": "sin distrito",
  "tut.sz.ax.eqLabel": "Una baza ganada en la casilla marcada",
  "tut.sz.ax.eqBasis": "Base **{v}**",
  "tut.sz.ax.eqStep": "× {nm} {f} = **{v}**",
  "tut.sz.ax.eqDistrikt": "× distrito {f} ({n} vecinos) = **{v}**",
  ...
  "tut.sz.ax.distriktMerk": "**Dos edificios de la misma categoría que se tocan.** Los dos son azules, o sea valor, y cada uno cuenta como un vecino para el otro ({pct} %). Ninguna línea está cerrada, así que aquí hay distrito y ningún factor de estructura.",
  "tut.sz.na.auge": "Partida terminada",
  "tut.sz.na.zumRekord": "hasta el récord",
  "tut.sz.na.jeStich": "baza",
  "tut.sz.na.durchlaeufe": "ciclos",
  "tut.sz.na.naechster": "el siguiente a {n} M",
  "tut.sz.na.dp": "Puntos de mazo",
  "tut.sz.na.bestLab": "Mejores marcas",
  "tut.sz.na.besteSerie": "Mejor racha",
  "tut.sz.na.besterStich": "Mejor baza",
  "tut.sz.na.meisteCrits": "Más golpes críticos",
  "tut.sz.na.score.nm": "Puntuación y récord",
  "tut.sz.na.score.txt": "Arriba del todo está lo que dio la partida. Al lado, lo lejos que estás de tu récord, o que lo acabas de superar.",
  "tut.sz.na.marken.nm": "Hitos",
  "tut.sz.na.marken.txt": "Cinco marcas en {m1}, {m2}, {m3}, {m4} y {m5} millones. Cada una que superas paga extra. Cuánto, en la próxima lección.",
  "tut.sz.na.waehrung.nm": "Puntos de baza y puntos de mazo",
  "tut.sz.na.waehrung.txt": "Las dos monedas. Los Puntos de baza compran nodos en el árbol de mejoras, los puntos de mazo compran en el taller el aspecto de tu mazo.",
  "tut.sz.na.best.nm": "Mejores marcas",
  "tut.sz.na.best.txt": "Mejor racha, mejor baza, más golpes críticos. Lo que fue récord nuevo en esta partida está marcado.",
  ...
  "tut.sz.nc.tap": "Toca un carril.",
  "tut.sz.nc.decks": "Mazos",
  "tut.sz.nc.cover": "{n} nodos que suben el tope de terreno del Arquitecto de {cover} a {coverMax} casillas.",
  "tut.sz.nc.energy": "{n} nodos que suben la energía de orden de {energy} a {energyMax}.",
  "tut.sz.nc.rerolls": "{n} nodos, cada uno da un relanzamiento más en cada oferta: ventaja, edificio y habilidad.",
  "tut.sz.nc.rarity": "{n} nodos: primero Muy rara, luego Épica, luego la capa dorada encima.",
  "tut.sz.nc.drops": "{n} nodos para ventajas y edificios de más calidad en la oferta. Se abre tras Legendario.",
  "tut.sz.nc.perk2": "{n} nodos. El primero convierte la segunda fase de ventajas en una fase legendaria general.",
  "tut.sz.nc.decksTxt": "{n} nodos. Desbloquean Hielo y Planta y dan candidatos legendarios por arquetipo.",
  "tut.sz.fa.lenLab": "Longitud de la formación",
  "tut.sz.fa.lenN": "{n} cartas",
  "tut.sz.fa.wiederholung": "valores iguales seguidos",
  "tut.sz.fa.wechsel": "arriba, abajo, arriba",
  "tut.sz.fa.farbblock": "mismo palo seguido",
  "tut.sz.fa.treppe": "valores que suben o bajan",
  "tut.sz.sg.zu": "Límites cerrados",
  "tut.sz.sg.zuNm": "Límites cerrados",
  "tut.sz.sg.grenze": "Límite de segmento {n}",
  "tut.sz.sg.offen": "abierto",
  "tut.sz.sg.offenBonus": "abierto, con bono de límite",
  "tut.sz.sg.geschlossen": "cerrado",
  "tut.sz.sg.summeTxt": "Suma de los factores de formación de las quince cartas",
  "tut.sz.sg.zuMerk": "**Dos rojas en el primer segmento, cinco en el medio, dos en el último.** Solo las cinco del medio forman un bloque. De las cuatro de los bordes no llega nada, aunque tienen el mismo palo y están justo al lado.",
  "tut.sz.sg.dreiMerk": "**Ahora es un bloque de nueve cartas.** Como el factor sigue subiendo con cada carta, la última lleva claramente más que el máximo anterior.",
  "tut.sz.sg.vierMerk": "**{segIV} añade un recargo a cada carta del bloque.** También a las dos primeras, que por sí solas no llevan factor alguno.",
  "tut.sz.b1.kopf": "Fuego + Arquitecto",
  "tut.sz.b1.unter": "La estructura eleva las brasas",
  "tut.sz.b1.satz": "El **dividendo de brasas** de Fuego es puntuación pagada directamente que no pasa por ningún multiplicador. Ni racha ni crítico ni formación lo elevan. La estructura del Arquitecto sí.",
  "tut.sz.b1.t1": "La estructura del Arquitecto",
  "tut.sz.b1.e1": "Una fila, columna o diagonal completa eleva la puntuación de cada carta que gana ahí. Sobre el dividendo de Fuego actúa **el doble de fuerte**.",
  "tut.sz.b1.t2": "Lo que sale de ahí",
  "tut.sz.b1.e2": "Una fila completa da ×{rowFactor} a la puntuación, pero **×{rowAmp}** al dividendo. Una columna completa ×{colFactor} y **×{colAmp}**.",
  "tut.sz.b1.ende": "Para Fuego, la geometría es así la única palanca que también eleva la parte que nada más alcanza.",
  "tut.sz.b2.kopf": "Fuego + Rayo",
  "tut.sz.b2.unter": "El valor de carta sostiene la racha",
  "tut.sz.b2.satz": "Fuego se encarga de que ganes. Rayo se encarga de que cada victoria valga.",
  "tut.sz.b2.t1": "Valor de carta de Fuego",
  "tut.sz.b2.e1": "{schmiede} pone **+{forgeValue} de valor de carta** en tu carta más débil. {gk} da **+{glowV1}** desde el {glowT1} % de calor, **+{glowV2}** desde el {glowT2} %, **+{glowV3}** al {glowT3} %.",
  "tut.sz.b2.t2": "Las victorias sostienen la racha",
  "tut.sz.b2.e2": "Valores más altos significan menos derrotas, y cada derrota pone la racha a cero. Cada punto de racha es **+{streakPct} %**.",
  "tut.sz.b2.t3": "Rayo entrega los críticos",
  "tut.sz.b2.e3": "Cada habilidad de Rayo que tienes da **+{critPerSkill} % de probabilidad de crítico**, y un crítico es **×{critMult}**. Golpea entonces una baza que ya está alta.",
  "tut.sz.b2.ende": "La retroalimentación: victorias con mucha ventaja mantienen alto el calor, y el calor mantiene la hoja en su nivel alto.",
  "tut.grundlagen.title": "Fundamentos",
  "tut.grundlagen.wasist.0": "Un juego de cartas que se juega solo. Carta contra carta, gana el valor más alto. Nunca intervienes en una baza; tus decisiones ocurren antes.",
  "tut.grundlagen.wasist.1": "{cards} cartas en un orden fijo, {suits} palos con valores de {rankMin} a {rankMax}. Tu orden se mantiene toda la partida y solo puede cambiarse en la fase de orden. El rival vuelve a barajar antes de cada ciclo.",
  "tut.grundlagen.wasist.1.label": "Tu mazo",
  "tut.grundlagen.wasist.2": "{cycles} ciclos. Después de cada uno tomas una decisión, y el plan fija cuál.",
  "tut.grundlagen.wasist.2.label": "Una partida",
  "tut.grundlagen.wasist.3": "Habilidad, {nSkill} veces. Una de {skillsOffered} ofertas; tienes {slots} ranuras de habilidad. · Ventaja, {nPerk} veces. Una de {perksOffered} ofertas, actúa enseguida y se queda. · Fase de orden, {nForm} veces. Cambiar el orden de tus cartas. · Arquitecto, {nShop} veces. Colocar edificios en tu tablero; actúan sobre la carta de debajo. · Legendaria, {nLeg} vez. Solo si está desbloqueada, en el ciclo {cycle}.",
  "tut.grundlagen.wasist.4": "No puedes perder. Después de {cycles} ciclos la partida termina, y lo único que cuenta es tu puntuación.",
  "tut.grundlagen.wasist.title": "Qué es Autobaza",
  "tut.grundlagen.werte.0": "Gana esta baza.",
  "tut.grundlagen.werte.1": "Las ventajas y las habilidades dan valor de baza. El valor de carta por sí solo rara vez decide.",
  "tut.grundlagen.werte.title": "Valor de carta y valor de baza",
  "tut.m.duell.name": "La baza del centro",
  "tut.m.duell.text": "Tu carta contra la del rival, ambas con su valor de combate. Debajo, quién ha ganado.",
  "tut.m.kopf.name": "Cabecera",
  "tut.m.kopf.text": "Puntuación, racha y ciclo. Los tres números que describen cómo va la partida.",
  "tut.m.mult.name": "Los multiplicadores",
  "tut.m.mult.text": "Formación, edificios, probabilidad de crítico y multiplicador de crítico. Lo que hay aquí actúa en cada victoria.",
  "tut.m.stat.name": "Victorias, derrotas, tasa",
  "tut.m.stat.text": "El balance de la partida. Debajo, el origen de la puntuación abre el desglose.",
  "tut.next": "Siguiente",
  "tut.openGlossary": "Abrir el glosario",
  "tut.pflanze.feld.0": "Toca cartas para hacerlas madurar.",
  "tut.pflanze.feld.1": "Muchas cartas verdes te dan **más bloques de palo**, pero cada uno se queda en ×{greenCap}. Para que una baza pague de verdad, la carta también tiene que haberse vuelto **más valiosa**, y eso solo pasa en la construcción pura de Planta.",
  "tut.pflanze.feld.title": "El campo verde",
  "tut.pflanze.karte.0": "Déjala crecer y mira.",
  "tut.pflanze.karte.1": "El crecimiento nunca retrocede. Una carta que una vez es verde sigue verde, aunque luego pierda bazas.",
  "tut.pflanze.erkennen.title": "En qué lo reconoces",
  "tut.pflanze.erkennen.0": "Tres señales en la carta.",
  "tut.pflanze.erkennen.1": "El anillo solo corre mientras crece y aún no está madura. Cuando desaparece, está madura.",
  "tut.pflanze.karte.title": "La carta",
  ...
  "tut.pflanze.tipps.1": "Lo que hace cada habilidad está en el glosario.",
  "tut.pflanze.tipps.title": "Consejos para empezar",
  "tut.pflanze.title": "Planta",
  "tut.pflanze.wasist.0": "Tus propias cartas crecen cuando ganan, y solo hacia arriba. Con suficiente crecimiento se vuelven verdes para siempre.",
  "tut.pflanze.wasist.1": "Cada victoria da crecimiento a la carta, a ritmo pleno a partir de {plantSkillRef} habilidades de Planta. Con {plantGreen} de crecimiento se vuelve verde; por debajo se llama plantón.",
  "tut.pflanze.wasist.1.label": "Pasiva",
  "tut.pflanze.wasist.2": "Si solo llevas habilidades de Planta, cada {plantPerValue} de crecimiento añaden {plantPerValue2} de valor de carta, hasta {plantCap}. Una sola habilidad ajena lo desactiva.",
  "tut.pflanze.wasist.3": "Crecimiento. Un número en cada una de tus cartas. Sube con cada victoria de esa carta y nunca baja. · Verde. Con {plantGreen} de crecimiento una carta está madura. Las cartas verdes cuentan como el mismo palo aunque no lo sean. · Valor. En una construcción de Planta pura el crecimiento también hace la carta más fuerte, no solo verde.",
  "tut.pflanze.wasist.4": "Las victorias hacen crecer las cartas, las cartas crecidas ganan más fácil, y las bazas ganadas con más facilidad las hacen crecer más.",
  "tut.pflanze.wasist.title": "Qué es Planta",
  "tut.probe.archmock.readout": "Lo que pone ahí",
  "tut.probe.archmock.title": "La pantalla de la fase de construcción",
  "tut.probe.aufstellen.none": "ninguna formación",
  "tut.probe.aufstellen.readout": "Formación",
  "tut.probe.aufstellen.title": "Práctica · un segmento",
  "tut.probe.bauen.none": "aún no has construido nada",
  "tut.probe.bauen.readout": "El nivel I da",
  "tut.probe.bauen.title": "Práctica · tu oferta",
  "tut.probe.baum.readout": "En total",
  "tut.probe.baum.title": "Dos ramas",
  ...
  "tut.probe.board.title": "Pruébalo · parte del tablero",
  "tut.probe.duell.readout": "Puntuación",
  "tut.probe.duell.title": "Práctica · cuatro bazas",
  "tut.probe.feuerkarten.readout": "Margen",
  "tut.probe.feuerkarten.title": "Práctica · forja y marca",
  ...
  "tut.probe.gletscher.readout": "Masa",
  "tut.probe.gletscher.title": "Práctica · masa",
  "tut.probe.gletscherfeld.readout": "Glaciares",
  "tut.probe.gletscherfeld.title": "Las cuatro formas",
  "tut.probe.gomock.readout": "Lo que pone ahí",
  "tut.probe.gomock.title": "La pantalla final",
  "tut.probe.gruenfeld.readout": "Maduras",
  "tut.probe.gruenfeld.title": "Quince cartas, tres segmentos",
  "tut.probe.herkunft.readout": "Puntuación",
  "tut.probe.herkunft.title": "La cadena desde abajo",
  "tut.probe.hitze.readout": "Dividendo de brasas",
  "tut.probe.hitze.title": "La barra de cero a lleno",
  "tut.probe.kampfwert.readout": "Puntuación",
  "tut.probe.kampfwert.title": "Práctica · el valor de combate",
  "tut.probe.kartenteile.none": "ninguna formación",
  "tut.probe.kartenteile.readout": "Esta carta",
  "tut.probe.kartenteile.title": "Segmento · toca para verla",
  "tut.probe.kategorien.readout": "Esta categoría",
  "tut.probe.kategorien.title": "Seis categorías",
  "tut.probe.laenge.readout": "Cartas",
  "tut.probe.laenge.title": "Longitud de la formación",
  "tut.probe.laufmock.readout": "Lo que pone ahí",
  "tut.probe.laufmock.title": "La pantalla durante la partida",
  ...
  "tut.probe.pflanzkarte.readout": "Crecimiento",
  "tut.probe.pflanzkarte.title": "Práctica · crecimiento",
  ...
  "tut.probe.segmente.readout": "Carta más fuerte",
  "tut.probe.segmente.title": "Quince cartas, dos límites",
  "tut.probe.serie.readout": "Racha más larga",
  "tut.probe.serie.title": "Práctica · el orden",
  ...
  "tut.r.1": "Es la que más aparece y es la entrada a una familia.",
  "tut.r.2": "Sustituye al nivel I y es más fuerte.",
  "tut.r.3": "Hay que desbloquearlo en el árbol de mejoras.",
  "tut.r.4": "El nivel más alto. Después la familia ya no vuelve a salir.",
  "tut.r.leg": "Sin familia y sin mejora, pero fuerte por sí solo.",
  "tut.resume": "Continuar",
  "tut.seen": "leído",
  ...
  "tut.wahl.kategorien.1": "A la derecha está cuántas familias tiene cada categoría, {perkFamilies} en total.",
  "tut.wahl.kategorien.title": "Las categorías",
  "tut.wahl.perks.0": "Las dos son efectos permanentes que vas consiguiendo durante la partida. Se diferencian en cómo las consigues y en si te las quedas.",
  "tut.wahl.perks.1": "Llega en la fase de ventajas, {nPerk} veces por partida. Eliges una de {perksOffered} y rechazar está permitido. Actúa enseguida y se queda hasta el final. No hay plazas, las ventajas se acumulan, y cada una solo puede elegirse una vez por partida.",
  "tut.wahl.perks.1.label": "Ventaja",
  "tut.wahl.perks.2": "Llega en la fase de habilidades, {nSkill} veces por partida. Tienes {slots} como mucho; si está lleno, una nueva sustituye a una vieja. Cada habilidad pertenece a un arquetipo, y la primera de su clase desbloquea su mecánica.",
  "tut.wahl.perks.2.label": "Habilidad",
  "tut.wahl.perks.3": "Cambiar una habilidad puede compensar si ya has cobrado su bono. La plaza vuelve a quedar libre y lo cobrado se queda.",
  "tut.wahl.perks.title": "Ventajas y habilidades",
  "tut.wahl.raritaet.0": "Cuatro niveles, y al lado lo legendario.",
  "tut.wahl.raritaet.1": "Una familia nunca aparece dos veces en el mismo nivel. Si la ves en la oferta, siempre es el siguiente nivel.",
  "tut.wahl.legendaer.title": "Legendario",
  "tut.wahl.legendaer.0": "Tres ejemplos, tres tipos de poder.",
  "tut.wahl.legendaer.1": "Uno por partida es la norma: la fase legendaria llega una vez, en el ciclo {cycle}.",
