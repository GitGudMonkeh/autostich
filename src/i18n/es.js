...
export default {
  ...
  "tut.a.boost.name": "Combos y formaciones",
  "tut.a.boost.text": "Dos interruptores para la vista previa. Muestran lo que las estructuras y las formaciones aportarían a tu impulso.",
  "tut.a.brett.name": "El tablero",
  "tut.a.brett.text": "Las posiciones de tus cartas vistas desde arriba. Cada celda es una posición de tu mazo, y un edificio encima refuerza justo la carta que juega ahí.",
  "tut.a.kopf.name": "Cabecera",
  "tut.a.kopf.text": "Impulso de los edificios y terreno de obra. El impulso es lo que dan tus edificios juntos; el terreno, cuántas celdas puedes ocupar todavía.",
  "tut.a.plaene.name": "Los planos",
  "tut.a.plaene.text": "Tu oferta de esta fase. Cada plano muestra su forma, su categoría y lo que da.",
  ...
  "tut.architekt.hauptaktion.1": "Nivel | {zollhaus} | {kontor} · I | +{zoll1} | +{kontor1} · II | +{zoll2} | +{kontor2} · III | +{zoll3} | +{kontor3} · IV | +{zoll4} | +{kontor4}",
  "tut.architekt.hauptaktion.2": "Mejorar es la segunda acción principal. Cuesta la misma fase que una construcción nueva, pero no da ninguna celda nueva, sino que sube un edificio un nivel. Los edificios legendarios no tienen niveles, y el nivel IV es el final.",
  "tut.architekt.hauptaktion.3": "Se construye en cuanto tocas. El sitio lo buscas después, y mover y girar no cuestan nada.",
  ...
  "tut.architekt.tipps.0": "Una fila entera es la estructura más barata: {segment} celdas, y además es un segmento completo. · Una columna entera cuesta {rows} celdas y es la más fuerte. · Pon categorías iguales una al lado de otra, así cada edificio lleva un distrito para el otro. · Mover y girar no cuestan nada. Coloca primero y busca el sitio después.",
  ...
  "tut.architekt.wohin.2": "{base} es la puntuación base de una victoria, y los demás factores vienen encima como siempre. El distrito da un {districtPct} % por vecino de la misma categoría, y como mucho cuentan {districtCap}.",
  "tut.architekt.wohin.2.label": "Una baza ganada en la celda marcada",
  "tut.architekt.wohin.3": "La estructura solo cuenta cuando una línea está cerrada del todo, con los edificios que sea. Para el distrito basta con que categorías iguales se toquen.",
  ...
  "tut.fortgeschritten.glut.0": "Hay combinaciones en las que una parte agranda a la otra. Dos de ellas, y las dos siguen la misma idea. Aquí la primera.",
  "tut.fortgeschritten.glut.1": "El dividendo de brasas de Fuego es puntuación que se paga directamente y no pasa por ningún multiplicador. Ni la racha ni el crítico ni una formación de cartas lo suben. La estructura del arquitecto sí, y encima amplificada.",
  "tut.fortgeschritten.glut.1.label": "Fuego y Arquitecto",
  "tut.fortgeschritten.glut.2": "Una fila entera da {rowFactor} sobre la puntuación, pero {rowAmp} sobre el dividendo. Una columna entera {colFactor} y {colAmp}. Para Fuego la geometría es así la única palanca sobre la parte que no alcanza nada más.",
  "tut.fortgeschritten.glut.2.label": "Lo que sale de ahí",
  "tut.fortgeschritten.glut.3": "La duplicación vale solo para el dividendo de brasas. Sobre el resto de la puntuación esa misma estructura actúa con su factor normal.",
  "tut.fortgeschritten.glut.title": "Brasas sobre geometría",
  "tut.fortgeschritten.klinge.0": "Fuego se encarga de que ganes. Rayo se encarga de que cada victoria valga la pena. La forja de cenizas pone {forgeValue} de valor de carta en tu carta más débil, y la hoja incandescente {glowV1} desde un {glowT1} % de calor, {glowV2} desde un {glowT2} % y {glowV3} al {glowT3} %.",
  "tut.fortgeschritten.klinge.0.label": "Fuego y Rayo",
  "tut.fortgeschritten.klinge.1": "Valores más altos significan menos derrotas, y cada derrota pone la racha a cero. Cada punto de racha es un {streakPct} %. Rayo aporta entonces los críticos: un {critPerSkill} % por cada habilidad de Rayo en mano, y un crítico es {critMult}×. Cae sobre una baza que ya estaba alta de todas formas.",
  "tut.fortgeschritten.klinge.1.label": "Por qué se sostiene",
  "tut.fortgeschritten.klinge.2": "Hay un pero: la hoja incandescente solo cuenta desde su segundo nivel si tu última victoria tuvo {glowM2} de margen, y desde el tercero {glowM3}. Una derrota lo pone a cero.",
  "tut.fortgeschritten.klinge.3": "Las dos combinaciones tienen la misma forma: algo hace tus bazas más grandes, y otra cosa multiplica justo eso.",
  ...
  "tut.fortgeschritten.laenge.1": "El deslizador llega hasta {segment}, porque ahí termina el segmento. Lo que viene después es la lección siguiente.",
  ...
  "tut.fortgeschritten.segmente.0": "Las formaciones terminan en el segmento, o sea después de {segment} cartas. Aquí hay nueve rojas seguidas, atravesando dos límites. Mientras estén cerrados, solo cuentan las del centro.",
  "tut.fortgeschritten.segmente.1": "Abre los límites.",
  "tut.fortgeschritten.segmente.2": "Dos maneras de abrir un límite. La ventaja {segWork} abre uno en el nivel I, dos en el II, todos en el III, y en el IV además un recargo sobre cada carta que cruce un límite. El edificio {pillar} abre el límite de las filas que cubre.",
  "tut.fortgeschritten.segmente.3": "Un límite abierto no cambia ni una sola carta. Solo permite que una formación siga, y como el factor sube con la longitud, justo eso paga el doble.",
