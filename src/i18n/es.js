...
export default {
  ...
  "hint.e5.blitz.body": "Esta es tu barra de {arch}: tus críticos llenan la carga — cuando la barra está llena, una carta se ioniza.",
  ...
  "hint.e8.body": "Tu partida cuenta: Puntos de baza para el árbol de mejoras, puntos de mazo para el taller. Todo lo demás está en el Campo de pruebas, cuando quieras.",
