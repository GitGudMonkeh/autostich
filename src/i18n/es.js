...
export default {
  ...
  "tut.eis.feld.0": "Cambia entre las cuatro formas.",
  "tut.eis.feld.1": "Cada glaciar vecino refuerza la rotura. El número de la derecha es el factor que da la densidad de la forma, y ahí la forma más compacta gana a la más larga.",
  "tut.eis.feld.1.label": "Por qué cuentan los vecinos",
  "tut.eis.feld.2": "Una línea tiene pocos vecinos, un bloque muchos. Dónde congelas decide el factor tanto como cuánta masa se junta.",
  "tut.eis.feld.title": "El campo de glaciares",
  "tut.eis.karte.0": "Sube la masa y mira los tres niveles.",
  "tut.eis.karte.1": "Por debajo de {massT1} de masa una rotura no paga nada. Desde {massT1} la fuerza es {wucht1}, desde {massT2} {wucht2}, desde {massT3} {wucht3}. La escarcha de la carta salta justo en esos umbrales.",
  "tut.eis.karte.1.label": "Tres niveles",
  "tut.eis.karte.2": "La escarcha no crece de forma uniforme. Desde fuera se ve qué nivel ha alcanzado un glaciar.",
  "tut.eis.karte.title": "La carta",
  "tut.eis.sub": "Acumular masa, romper glaciares.",
  "tut.eis.tipps.0": "Cada habilidad de Hielo congela una carta. También un cambio con las ranuras de habilidad llenas. · La masa llega en cada ciclo, sin condiciones, y con una victoria otra vez. · Por debajo de {massT1} de masa una rotura no paga nada. No dejes que llegue demasiado pronto. · Congela cerca unos de otros. Los vecinos refuerzan cada rotura.",
  ...
  "tut.feuer.feld.0": "Arrastra la barra y mira qué se enciende.",
  "tut.feuer.feld.1": "El dividendo de brasas es puntuación directa en cada victoria de fuego y crece hasta un {dividendCap} %. La hoja incandescente da {glowV1} desde un {glowT1} % de calor, {glowV2} desde un {glowT2} % y {glowV3} al {glowT3} %.",
  "tut.feuer.feld.1.label": "Lo que depende del calor",
  "tut.feuer.feld.2": "Por encima de un {dividendCap} % el dividendo ya no añade ni un punto. Seguir calentando compensa igualmente, porque la hoja solo alcanza sus niveles altos más allá.",
  "tut.feuer.feld.title": "La barra de calor",
  "tut.feuer.karte.0": "Forja tu carta y marca a fuego la suya.",
  "tut.feuer.karte.1": "Cada victoria marca a fuego una carta del rival y da {brandAsh} de ceniza. Al final de cada ciclo, cada {forgeCost} de ceniza se convierten en una forja, y la forja de cenizas da {forgeValue} de valor permanente a tu carta más baja. Después la más baja es otra.",
  "tut.feuer.karte.1.label": "Cómo funciona la forja",
  "tut.feuer.karte.2": "Las dos cosas amplían tu margen. El valor forjado se queda en el mazo de forma permanente, incluso después de cambiar una habilidad. Las marcas no se acumulan: una nueva sustituye a la vieja.",
  "tut.feuer.karte.title": "Las cartas",
  "tut.feuer.sub": "Margen, calor, ceniza.",
  "tut.feuer.tipps.0": "Una victoria ajustada no calienta. Solo a partir de {heatMinMargin} de margen pasa algo. · La forja sube siempre la carta MÁS BAJA. Va tirando de tu mazo desde abajo. · El dividendo de brasas no pasa por ningún multiplicador, y aun así la estructura del arquitecto lo sube. · Las derrotas cuestan calor, pero con tope. Una sola no te echa atrás.",
  ...
  "tut.pflanze.feld.0": "Cambia cuánto de tu mazo está maduro.",
  "tut.pflanze.feld.1": "Las cartas verdes cuentan como el mismo palo. Por eso un segmento de puras cartas maduras es un bloque de palo, sean cuales sean los palos que tuvieran al principio.",
  "tut.pflanze.feld.1.label": "Por qué eso da un bloque de palo",
  "tut.pflanze.feld.2": "El factor de abajo sale del mismo cálculo que en la partida. La madurez sustituye al palo, no al orden.",
  "tut.pflanze.feld.title": "El campo verde",
  "tut.pflanze.karte.0": "Sube el crecimiento y cambia las habilidades.",
  "tut.pflanze.karte.1": "El número se va tiñendo con el crecimiento, del color del palo al verde. Con {plantGreen} de crecimiento está madura: la carta recibe un borde verde y el número se ilumina.",
  "tut.pflanze.karte.1.label": "Cómo lo reconoces",
  "tut.pflanze.karte.2": "El crecimiento nunca retrocede. Una carta que ha sido verde una vez sigue verde, aunque más tarde pierda bazas.",
  "tut.pflanze.karte.title": "La carta",
  "tut.pflanze.sub": "Crecimiento, cartas verdes, el campo.",
  "tut.pflanze.tipps.0": "El crecimiento nunca baja. Cada victoria es un paso que te quedas. · Una habilidad ajena te cuesta el aumento de valor, no el verde. · Las cartas verdes forman bloques de palo por encima de su palo real. Esa es la ganancia de verdad. · Deja que tus cartas fuertes ganen a menudo, así maduran primero.",
