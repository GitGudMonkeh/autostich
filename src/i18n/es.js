...
export default {
  ...
  "hint.sf1.body": "Toca dos cartas para intercambiar sus posiciones. Intenta juntar el mismo color dentro de un segmento.",
  ...
  "hint.h4.body": "La i de arriba abre el glosario: allí puedes consultar casi todo.",
  ...
  "tut.back": "Atrás",
  "tut.blitz.karte.0": "En todos los demás arquetipos el crítico es azar — Rayo se lo fabrica él mismo. Ponle marcas y mira cómo cambia la carta.",
  ...
  /* ---- Start screen (StartScreen.jsx) ----
     ...
     missing translation. */
  "start.tutorial": "Campo de pruebas",
