...
export default {
  ...
  "tut.aufstellung.brett.0": "Toca dos cartas para intercambiarlas.",
  "tut.aufstellung.brett.1": "A la izquierda, la energía que te queda. A la derecha, el multiplicador de formación de este orden. Solo cuenta en las bazas que ganas.",
  "tut.aufstellung.brett.1.label": "Lo que dice el indicador",
  "tut.aufstellung.brett.2": "Deshacer retira el último intercambio y devuelve la energía. Reiniciar restaura el orden inicial.",
  "tut.aufstellung.brett.title": "El tablero",
  "tut.aufstellung.formationen.0": "Reordena hasta que se detecte algo.",
  "tut.aufstellung.formationen.1": "Repetición: dos o más valores iguales seguidos. · Bloque de palo: tres o más cartas del mismo palo seguidas. · Escalera: tres o más valores que suben o bajan sin interrupción, con un paso de {treppeStep} como mucho. · Alternancia: arriba, abajo, arriba. Cada distancia entre vecinas de {wechselDiff} como mínimo.",
  "tut.aufstellung.formationen.2": "Cuanto más larga es una formación, más alto su factor.",
  "tut.aufstellung.formationen.title": "Las cuatro formaciones",
  "tut.aufstellung.karte.0": "Toca una carta.",
  "tut.aufstellung.karte.1": "Cada {segment} cartas forman un segmento, y {segments} segmentos dan las {cards} cartas de un ciclo. Una formación solo vale hasta el final de su segmento. Algunas ventajas y edificios abren los límites de segmento, y entonces sigue más allá.",
  "tut.aufstellung.karte.1.label": "Todo tu mazo",
  "tut.aufstellung.karte.2": "Una repetición ya paga desde la segunda carta. El bloque de palo, la escalera y la alternancia llevan su marca desde la segunda pero solo pagan desde la tercera.",
  ...
  "tut.aufstellung.stapeln.0": "Consigue que una carta esté en dos formaciones a la vez.",
  "tut.aufstellung.stapeln.1": "Si una carta está en dos formaciones, sus factores se multiplican. Dos pequeños superan enseguida a uno grande.",
  "tut.aufstellung.stapeln.1.label": "Qué pasa entonces",
  "tut.aufstellung.stapeln.2": "Si ganas la baza, el multiplicador cuenta. Si la pierdes, no cuenta nada, por alto que fuera.",
  ...
  "tut.back": "Atrás",
  "tut.blitz.karte.0": "Pon marcas en la carta y mira los dos valores.",
  "tut.blitz.karte.1": "A la izquierda, lo que paga de más la propia carta al ganar. A la derecha, la probabilidad de crítico de todo el mazo, y esa cuenta TODAS las marcas, no solo las de esta carta. Con {ionCap} marcas se acaba, y eso es un {ionCapPct} %.",
  "tut.blitz.karte.1.label": "Qué hacen estas marcas",
  "tut.blitz.karte.2": "Una carta admite {ionMax} marcas como mucho. Si está llena, lo que aún cayera sobre ella se pierde.",
  "tut.blitz.karte.title": "La carta",
  "tut.blitz.sub": "Ionización, carga, golpes críticos.",
  "tut.blitz.tipps.0": "La primera habilidad de Rayo es la que más compensa: trae el zócalo consigo. · Probabilidad de crítico sin multiplicador de crítico vale la mitad, y al revés igual. · La ionización es permanente. Lo que se posa una vez en una carta se queda toda la partida. · Reparte las marcas en vez de llenar una carta. El tope cuenta todo el mazo.",
  ...
  "tut.wahl.kategorien.0": "Toca una categoría.",
  "tut.wahl.kategorien.1": "En total son {perkFamilies} familias. El número de la casilla dice cuántas de ellas pertenecen a esa categoría.",
  ...
  "tut.wahl.raritaet.0": "Toca un nivel.",
  "tut.wahl.raritaet.1": "Sustituir, no acumular. Si tomas el nivel II, desaparece el nivel I.",
  "tut.wahl.raritaet.2": "Las ventajas legendarias quedan fuera de los niveles: sin familia, sin mejora, con marco dorado. Una sola puede decidir en qué acaba tu partida.",
  "tut.wahl.raritaet.2.label": "Legendario",
  "tut.wahl.raritaet.3": "Los niveles más altos son más fuertes y se ofrecen con menos frecuencia. El nivel IV cierra una familia, y después ya no vuelve a salir.",
