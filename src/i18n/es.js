...
export default {
  ...
  "tut.eis.einfrieren.title": "Congelar",
  "tut.eis.einfrieren.0": "Cómo nacen los glaciares nuevos.",
  ...
  "tut.sz.ee.s1": "**Cada habilidad de Hielo congela una carta.** También un cambio con los huecos de habilidad llenos. Tú eliges la carta; después se queda en su posición.",
  "tut.sz.ee.s2": "**Desde {n} habilidades de Hielo, rechazar también congela.** Entonces puedes tener más glaciares que huecos de habilidad.",
  "tut.sz.ee.merk": "**Construir denso compensa.** Los glaciares contiguos se refuerzan entre sí en cada rotura.",
