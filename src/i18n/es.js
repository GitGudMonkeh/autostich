...
export default {
  ...
  "tut.fortgeschritten.segmente.2": "Dos maneras de abrir un límite. La ventaja Segmentarbeit abre uno en el nivel I, dos en el II, todos en el III, y en el IV además un recargo sobre cada carta que cruce un límite. El edificio Pfeiler abre el límite de las filas que cubre.",
  ...
  "tut.grundlagen.anzeigen.0": "Toca una zona.",
  "tut.grundlagen.anzeigen.1": "Las barras de color de calor, carga, crecimiento y masa solo aparecen cuando juegas un arquetipo. Sin habilidades de un arquetipo ese lado se queda vacío.",
  "tut.grundlagen.anzeigen.1.label": "Lo que aparece más tarde",
  "tut.grundlagen.anzeigen.2": "El origen de la puntuación abre el desglose de la partida. También está en la pantalla final.",
  "tut.grundlagen.anzeigen.title": "La pantalla de partida",
  "tut.grundlagen.herkunft.0": "Al final hay un número, y debajo lo que lo ha producido. Cada línea es un factor.",
  "tut.grundlagen.herkunft.0.label": "Después de la partida",
  "tut.grundlagen.herkunft.1": "Ve encendiendo las líneas y mira crecer la suma.",
  "tut.grundlagen.herkunft.2": "Una puntuación es un producto, no una suma. Por eso un factor no paga nada en una baza perdida.",
  "tut.grundlagen.herkunft.title": "De dónde sale tu puntuación",
  "tut.grundlagen.score.0": "Puntos base por racha por ventajas por formación por crítico, en ese orden y el crítico al final. Los puntos base son {base} por victoria; una puntuación directa los sube antes de que se multiplique nada.",
  "tut.grundlagen.score.0.label": "Así calcula el juego cada baza",
  "tut.grundlagen.score.1": "Enciende y apaga los factores.",
  "tut.grundlagen.score.2": "De las ventajas y las habilidades. Cada elección sube o bien los puntos base o bien un factor, y lo hace de forma permanente. Actúa en cada victoria posterior, o sea en la puntuación de toda la partida.",
  "tut.grundlagen.score.2.label": "De dónde salen los factores",
  "tut.grundlagen.score.3": "Una victoria que cuenta más: la base por {critMult}. Ocurre al azar. Tu probabilidad de crítico empieza en cero y sale de las ventajas y las habilidades.",
  "tut.grundlagen.score.3.label": "Qué es un crítico",
  "tut.grundlagen.score.4": "Cada factor multiplica el resultado. Dos juntos hacen más que cualquiera por separado.",
  "tut.grundlagen.score.title": "La puntuación",
  "tut.grundlagen.serie.0": "Intercambia dos de tus cartas y mira cuánto se alarga la racha.",
  "tut.grundlagen.serie.1": "Cada victoria seguida es un punto de racha, y cada punto de racha sube el multiplicador un {streakPct} %. Una derrota pone la racha a cero, y un empate también.",
  "tut.grundlagen.serie.1.label": "Lo que paga la racha",
  "tut.grundlagen.serie.2": "Las mismas cartas, otro orden, otra racha. La fase de orden es lo que lo decide.",
  "tut.grundlagen.serie.title": "La racha",
  "tut.grundlagen.stich.0": "Cuatro bazas. Toca jugar y mira.",
  ...
  "tut.grundlagen.werte.0": "Pon un valor de baza en tu carta y luego juega la baza.",
  "tut.grundlagen.werte.1": "El valor de carta está en la carta de forma permanente. Un valor de baza cuenta solo para esa baza. Los dos juntos son el valor de combate, y la carta muestra exactamente ese número. Solo él decide.",
  "tut.grundlagen.werte.1.label": "Los tres números",
  "tut.grundlagen.werte.2": "Las ventajas y las habilidades dan valor de baza. El valor de carta por sí solo rara vez decide.",
