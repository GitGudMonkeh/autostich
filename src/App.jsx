...
import { THEMES, unlockAllCosmetics, activeBgFx, activeBgFinisher, activeCardAnims } from "./game/themes.js";
...
export function Autostich() {
  ...
  const deckFx = {
    ...
    finisher: (options.finisher === "klinge" && !!profile?.ownedCosmetics?.["fx:klinge"]) ? "klinge" : "standard",
          ...
          <div className="grid lg:grid-cols-[1fr_340px] gap-4 items-start">
            <div className="grid gap-4 order-1 lg:col-start-1 lg:row-start-1">
              ...
              <Battlefield lastTrick={state.lastTrick} remaining={cycleLenFor(state.shop) - state.pos} deckLen={cycleLenFor(state.shop)} flipMs={flipMs} pe={bfPe}
                ...
                starfieldDeck={deckFx.starfieldDeck} cubematrixDeck={deckFx.cubematrixDeck} finisher={deckFx.finisher} cardAnims={deckFx.cardAnims}
