...
export function Autostich() {
  ...
  return (
    <div className="min-h-screen w-full flex justify-center px-4 py-6">
      ...
      {/* Archiv-Marker — dieser Build ist die konservierte erste spielbare Version
          (/autostich/first-version/). Nur unter VITE_PREVIEW sichtbar, damit man die
          Archiv-Page nie mit der echten Seite verwechselt. Klick-durchlässig. */}
      ...
      {state.phase === "shop-target" && (
        <ShopTargetSelect state={state} onCard={shopTargetCard} onColor={shopTargetColor}
          ...
          onFormationType={shopTargetFormationType} onCategory={shopTargetCategory} onOffer={shopTargetOffer}
