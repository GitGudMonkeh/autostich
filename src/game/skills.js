...
const BLITZ = {
  ...
  feld:          [{ critPerCard: 0.05 }, { critPerCard: 0.07 }, { critPerCard: 0.10 }, { critPerCard: 0.15, feedLowest: 1 }], // §7.54: 2/3/4/6 maßen 0 % (§7.53 D). Die Achse trägt — die Crit-Chance ist bis Runde 40 ungesättigt (14,8 → 63,4 %, blitz-ramp) —, der Satz war zu klein: bei 45–73 % ionisierten Karten sind das ~2–3 leuchtende je Formation, also +4 bis +7 Punkte auf eine Basis von 42–63 %
