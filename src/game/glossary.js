...
/* ============================================================
   ...
   Struktur: GLOSSARY[id] = { category, group?, label, icon, img?, color, text, match? }.
...
export const GLOSSARY_CATEGORIES = [
  ...
  { id: "frak",  label: "Archetypen",         color: CLR.lightning, hint: "Die vier Ressourcen, nach Archetyp gruppiert." },
...
export const GLOSSARY = {
  /* ============ 1 · Grundbegriffe ============ */
  stich: { category: "grund", label: "Stich", icon: "⚔", color: CLR.grund,
  ...
  ziehreihenfolge: { category: "deck", label: "Ziehreihenfolge", icon: "⋮", color: CLR.deck,
    text: "Die feste Reihenfolge, in der deine Karten gespielt werden; sie bleibt über Durchläufe stabil (nur der Gegner mischt).",
  ...
  stapel: { category: "frak", group: "lightning", label: "Stapel (Ionisierung)", icon: "▤", color: CLR.lightning,
    text: `Eine Ionisierung auf einer einzelnen Karte, ohne Deckel. Jeder Stapel gibt bei Sieg mit der Karte +${C.ION_SCORE_PER_STACK} Score und +${de(C.ION_CRIT_MULT_PER_STACK)}× Crit-Multiplikator; Karten mit vielen Stapeln schalten die Schwellen-Skills frei (Blitzfänger, Kurzschluss, Überspannung).`,
  ...
  gebaeude: { category: "arch", label: "Gebäude", icon: "▣", color: CLR.arch,
    text: "Ein platziertes Gebäude. Es bufft die Karte, die auf seiner Position im Stich steht. Es überlappt nie mit anderen.",
    match: ["Gebäude"] },
