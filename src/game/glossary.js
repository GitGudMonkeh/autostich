...
export const GLOSSARY = {
  ...
  crit: { category: "grund", label: "Crit", icon: "⚡", color: CLR.lightning,
    text: `Kritischer Treffer: der Sieg zählt mit dem Crit-Multiplikator (Basis ×${de(C.CRIT_BASE_MULT)}). Der Basis-Crit ist 0 — Crit-Chance kommt aus den Präzision-Familien und aus Blitz-Skills.`,
  ...
  anker: { category: "form", label: "Anker", icon: "⚓", color: CLR.neutral,
    text: `Eine einzelne Position zählt als aktive Formation (×${de(C.ANCHOR_FORM_FACTOR)}). Aus einem Eisanker oder dem Architekten. Höchstens ein Anker je Position. Das Gebäude Grundstein legt ab Stufe III zusätzlich Stichwert auf jede Ankerzelle.`,
  ...
  struktur: { category: "arch", label: "Struktur-Boni", icon: "✶", color: CLR.arch,
    text: "Eine vollständig bebaute Zeile, Spalte oder Diagonale (eine vollendete Struktur) gibt einen Multiplikator; sie stapeln multiplikativ. Manche Gebäude (Ballung) zahlen zusätzlich je vollendeter Struktur.",
    match: ["Struktur-Boni", "vollendete Struktur", "vollendeter Struktur", "vollendete Strukturen", "Struktur", "Strukturen", "Struktur-Kombi", "Ballung"] },
  ...
  abgedecktezelle: { category: "arch", label: "Abgedeckte Zelle", icon: "▨", color: CLR.arch,
    text: "Eine Brettzelle, die unter einem platzierten Gebäude liegt. Eckstein und Dichte Bebauung zahlen je abgedeckter Zelle.",
