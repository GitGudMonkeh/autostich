...
export const GLOSSARY = {
  ...
  nachhall: { category: "form", label: "Nachhall", icon: "〜", color: CLR.neutral,
    text: "Der Faktor einer endenden Formation hält nach und überträgt sich auf die direkt folgende Karte.",
    match: ["Nachhall"] },
  ...
  grenzbonus: { category: "form", label: "Grenzbonus", icon: "⇥", color: CLR.neutral,
    text: "Karten einer Formation, die eine Segmentgrenze überschreitet, geben zusätzlich ×1,25 (aus Segmentarbeit IV).",
    match: ["Grenzbonus"] },
  ...
  farbtransparenz: { category: "form", label: "Farbblock-Transparenz", icon: "🔷", color: CLR.neutral,
    text: "Eine so markierte Karte unterbricht einen Farbblock nicht — sie wird übersprungen (transparent) und zählt selbst nicht als Mitglied, sodass der Farbblock über eine andersfarbige Karte hinwegläuft. Kommt vom Architekt-Gebäude Arkade.",
  ...
  glutdividende: { category: "frak", group: "fire", label: "Glutdividende", icon: "🔥", color: CLR.fire,
    text: "Ein direkter Score je Feuer-Sieg, der NICHT durch Serie/Crit/Formation multipliziert wird — hebt das frühe Spiel (∝ gehaltener Hitze, gedeckelt).",
    match: ["Glutdividende"] },
  ...
  kaskade: { category: "frak", group: "lightning", label: "Kaskade", icon: "🔗", color: CLR.lightning,
    text: "Ereignis zündet Ereignis: ein Crit auf oder neben einer Karte mit Ionisierung erzeugt Zusatzladung — der Sturm nährt sich selbst.",
    match: ["Kaskade"] },
  ...
  schichten: { category: "frak", group: "ice", label: "Schichten", icon: "❖", color: CLR.ice,
    text: `Permanenter Kartenwert je Frostkarte (unverlierbar — der Spine). Je tiefer der Stapel, desto mehr Wert und Score. Wirksamer Deckel ${C.ICE_LAYER_MAX}; die Tiefe darüber füttert die Legendären.`,
    match: ["Schichten", "Schicht"] },
  bank: { category: "frak", group: "ice", label: "Bank (Ablage)", icon: "❄️", color: CLR.ice,
    text: "Ungenutzte Frosttausche banken Schicht-Fortschritt — Geduld verdichtet Schnee zu Gletschereis.",
    match: ["Bank", "Ablage", "banken", "bankt"] },
  eisanker: { category: "frak", group: "ice", label: "Eisanker", icon: "❄️", color: CLR.ice,
    text: `Eine Frostkarte steht als Anker (×${de(C.EISANKER_FACTOR)}) und lagert dabei garantiert eine Schicht ab — auch ohne volle Formation.`,
    match: ["Eisanker"] },
  ...
  wurzeln: { category: "frak", group: "plant", label: "Wurzeln", icon: "🌿", color: CLR.plant,
    text: "Der einzige Weg, den Kartenwert grüner Karten zu heben (bis zum Deckel). Tiefe zahlt danach in Score.",
