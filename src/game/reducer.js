...
export function initialState(rng = Math.random, seed = null) {
  ...
  return {
    ...
    zinsCapital: 0, zinsRate: C.ZINS_RATE_START, cycleWins: 0, cycleLosses: 0, cycleBestTrick: 0, sammlerTypes: [], vabanquePaid: 0, cycleOpenScore: 0, // Legendär-Perks-Rework (#203) + Zinseszins-Bank
    perks: [], offer: null,
