...
export const COSMETIC_OPTION_KEYS = ["deckId", "battlefieldId", "fxAurora", "fxNeonsurf", "fxStarfield", "finisher", "fxSonnenPuls", "fxLaserFaecher", "fxPrismaKaskade", "fxHoloCube", "fxSupernova", "archColor"];
