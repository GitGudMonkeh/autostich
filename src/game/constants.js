...
export const SKILL_SLOTS       = 6;    // max gleichzeitig gehaltene Skills [Test-Experiment: 4→6]
export const SKILLS_OFFERED     = 9;   // Skills je Skill-Runde (Test-Experiment: 3+3+3 — 3 pro Archetyp, alle 3 immer im Angebot)
