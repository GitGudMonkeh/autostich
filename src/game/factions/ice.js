...
// SK_ICE_12 Zermalmen, SK_ICE_L04 Erstarrung. §5.18 ersetzt: SK_ICE_13 Rissbildung → Gletscherzunge,
// SK_ICE_17 Eispanzer → Sprödbruch.)
...
export function iceTuning(roles = [], roleTiers = {}) {
  ...
  return {
    ...
    sproedbruchCrit: sb ? sb.crit : 0,           // Crit-Chance je Punkt Masse
    sproedbruchCritMass: sb && sb.critMass ? sb.critMass : 0, // Episch: Crit gibt Masse zurück
  };
}
