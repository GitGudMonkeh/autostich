...
### 7.57 §7.56 nachgemessen: null im Score, vier Runden in der Rampe (2026-09-10) — gemessen

Beide Seed-Sätze wie seit §7.53, dazu die Rampen-Sonde.

#### A · Im Score: die dritte Null

**Spannungsfeld +0 % / −2 %**, gehalten 78 / 54 %. Damit sind es drei Bauformen und drei Nullen:

| Bauform | Achse | Ergebnis |
| --- | --- | --- |
| §7.43/§7.47 | eigener Score-Multiplikator, je Stapel bzw. je ionisierter Karte | verdreifacht → drei von vier Stufen unter Lift 1 (§7.50) |
| §7.51/§7.54 | Crit-Chance je ionisierter Karte | ×2,5 → −1 % / +1 % |
| §7.56 | Crit-Chance je Formation, ohne Bedingung | **+0 % / −2 %** |

Die Fraktion bewegt sich ebenfalls nicht: 1.295M / 613M gegen 792M / 1.196M davor — beide Paare überlappen sich,
das ist Rauschen (§7.53).

#### B · In der Rampe: der Zweck ist erfüllt

`blitz-ramp`, 60 Läufe, gegen denselben Lauf vor §7.54/§7.56:

| | vorher | jetzt |
| --- | ---: | ---: |
| Crit-Chance Runden 1–10 | 14,8 % | 15,5 % |
| Crit-Chance Runden 21–30 | 41,7 % | **45,9 %** |
| **Median-Runde, in der die Crit-Chance 25 % erreicht** | 14 | **10** |
| Median-Runde der 5. vollen Leiste | 15 | **14** |
| Median-Runde der 10. vollen Leiste | 22 | **21** |
| Volle Leisten je Lauf | 150,1 | **163,1** |
| Stapel auf dem Deck je Lauf | 633,7 | **979,4** |

**Die 25-%-Marke fällt vier Runden früher.** Genau das war die Absicht („hilft früher Ladungen zu bekommen").

**Nicht getrennt:** in diesen Zahlen stecken §7.54 (Blitzschlag) und §7.56 zusammen. Blitzschlag braucht Crits, um
zu zünden, kann den Anstieg in den Runden 1–10 also kaum verursacht haben — der frühe Teil ist plausibel das Feld,
aber das ist eine Zuordnung, keine Messung. Trennbar wäre es mit einem Lauf ohne das Feld.

#### C · Warum beides zugleich stimmt

Der Score eines Laufs wächst exponentiell; die Runden 41–50 tragen ihn fast allein. **Ein Skill, der nur früh
hilft, ist im Median-Score praktisch unsichtbar** — er verschiebt den Startpunkt einer Kurve, deren Ende die Zahl
bestimmt.

Damit ist die Ablation, das Werkzeug dieser ganzen Reihe, für Früh-Skills das falsche Maß. Die richtige Kennzahl
ist der Meilenstein (welche Runde erreicht die 25 %, die 5. Leiste), nicht der Endstand. Das gilt rückwirkend für
jede „0 %"-Aussage über einen Skill, dessen Wirkung vorne liegt — bei Blitz sind das Spannungsfeld und, dem
Mechanismus nach, auch Gewitterfront.

#### D · Was das für die Entscheidung heißt

Der Skill tut, was er soll, aber in einer Größe, die im Endstand nicht ankommt: bei Normal (5 %) und rund 1,4
Formationen sind das **+7 Punkte Crit-Chance auf einem Formations-Sieg**, und Formations-Siege sind gut ein Drittel
der Stiche. Wer ihn im Score sehen will, muss ihn um ein Vielfaches größer machen — dann ist er allerdings früh
sehr stark, weil die Basis dort nur 15 % beträgt.

Offen, Owner-Entscheid: **Satz deutlich hoch** (er wird ein ausgesprochener Früh-Skill), oder **so lassen** und
akzeptieren, dass er eine Rampenhilfe ist, die die Ablation nicht sieht.
...
### 7.63 Streuungs Leiter gekürzt (2026-09-11, Owner) — umgesetzt, UNGEMESSEN

**Owner:** „kürzen" — von den zwei Tarier-Griffen aus §7.62 E der erste.

#### A · Was sich ändert

| Stufe | Karten vorher | jetzt | Anhang: Karte ohne Stapel bekommt |
| --- | ---: | ---: | ---: |
| Normal | 1 | 1 | 1 (wie bisher) |
| Selten | 2 | **1** | **2** |
| Sehr selten | 3 | **2** | 2 |
| Episch | 4 | **3** | **3** |

Die Kartenzahl fällt auf jeder Stufe außer Normal um eins; Episch streut 3 statt 4 Karten je Leiste. Bei Ø rund
150 vollen Leisten je Lauf sind das etwa **150 ionisierte Karten weniger** auf der höchsten Stufe.

#### B · Warum der Anhang gewandert ist

Der Vorschlag in §7.62 E lautete wörtlich „die Leiter auf 1/1/2/3 kürzen", und genau so gebaut wäre er falsch
gewesen: mit dem Anhang für leere Karten nur auf Episch hätten **Normal und Selten denselben Satz getragen** — ein
Stufenschritt, für den der Spieler zahlt und nichts bekommt.

Nachgesehen, statt geraten: **alle 58 gestuften Skills tragen heute vier verschiedene Stufentexte.** Das ist eine
Hausregel, die bisher nur niemand aufgeschrieben hatte. Der Anhang sitzt deshalb jetzt ab Selten und steigt auf
Episch noch einmal — vier Stufen, vier Texte, jede Stufe ändert etwas.

Ein Wächter hält die Regel ab sofort **für alle gestuften Skills**, nicht nur für diesen: `descTiers` muss vier
verschiedene Texte haben (vorher: mehr als einen). Gegengeprobt, indem der Selten-Anhang wieder entfernt wurde —
er fällt mit „SK_LIGHTNING_17: zwei Stufen mit demselben Text".

#### C · Was das voraussichtlich NICHT schafft

§7.62 B hat Blitz bei **3,18 / 2,92× Feuer** gemessen, nach einem Anstieg um +63 / +48 %. Dieser Schnitt nimmt
Streuung rund ein Viertel ihrer Ionisierung auf den oberen Stufen — er wird die Fraktion senken, aber die
Größenordnung reicht rechnerisch nicht, um allein auf die 1,96× von vorher zurückzukommen. **Der zweite Griff (der
Satz der Zündspannung) bleibt damit wahrscheinlich nötig**; das entscheidet die Messung, nicht diese Vorhersage.
...
> **KORRIGIERT (2026-09-11, noch in derselben Sitzung).** Der Absatz darüber ist in zwei Punkten nicht gedeckt.
> **Erstens ist `gross-45` EIN Seed-Satz** (`params.seed0: 1`), während +160 / +13 % jeweils der höhere von zwei
> Sätzen sind (Lichtbogen 160 s1 gegen 90 s101, Kettenblitz 6 s1 gegen 13 s101). §7.62 C misst Lichtbogen bei
> ION = 75, also VOR dem Regler, mit **+107 / +3 %** — auf einem Seed-Satz stand er da schon bei 3 %. Der Sprung
> zwischen Seed-Sätzen ist hier größer als der behauptete Fall; das ist der Fehler, den §7.62 C selbst beschreibt.
> **Zweitens stimmt die Begründung für Lichtbogen mechanisch nicht:** er zahlt `critPerStack`, also Stapel zu
> Crit-CHANCE, und `ION_SCORE_PER_STACK` bewegt den Stapel-SCORE. Für Kettenblitz trägt sie (er macht Stapel, und
> Stapel zahlen über den Score), für Lichtbogen nicht. Dazu trennt `gross-45` den Bau aus §7.66 nicht um eine
> Änderung, sondern um drei (§7.67 nimmt beide Schnitte zurück, §7.69 senkt den Regler). **Was bleibt:** beide
> messen auf EINEM Seed-Satz unter 3 %; ob der Regler die Ursache ist, ist ungemessen.
...
3. **Lichtbogen und Kettenblitz** stehen auf EINEM Seed-Satz unter 3 %. Ob der Regler die Ursache ist, ist offen
   (KORRIGIERT in D); der zweite Seed-Satz gehört gemessen, bevor an ihren Zahlen gedreht wird.
...
1. **Eis synergiert nicht.** Das ist der Nachfolger der Ansteckung und kleiner als sie, aber es steht dem Ziel
   ...
   alles andere.
2. **Lichtbogen und Kettenblitz** stehen auf einem Seed-Satz unter 3 %; der zweite fehlt, und die Ursache ist
   nicht belegt (KORRIGIERT in §7.70 D).
...
| 2026-09-11 | Abschluss der Balancing-Reihe (§7.65–§7.75). **Blitz:** die zwei Skill-Schnitte (§7.63/§7.65) nahmen zusammen nur 15,6 / 9,2 % und machten dabei beide neuen Skills wirkungslos (§7.66 B) — Ablation misst „bessere Option als die Alternative" nicht (§7.66 C). Beide zurückgenommen (§7.67), stattdessen der EINE Regler: `ION_SCORE_PER_STACK` 75 → 45 (§7.69), vorher gesweept (§7.68). Die große Aufnahme traf den Sweep-Wert punktgenau: **Blitz 21,9 Mio** (§7.70 A). **Eis:** die Ansteckung war ein PREIS-Problem, kein Skill-Problem — ein Gletscher kostet eine Position und zahlte zu wenig; `BURST_SCALE` 20 → 80 (§7.71/§7.72) hebt Eis mono auf 17,8 und Fe+Ei von 0,83 auf 1,47× Feuer. Das korrigiert §8s Diagnose „zu wenige Skills". **Feuer:** `HEAT_MULT_PER_10` 0,02 → 0,05 (§7.73/§7.74); der Hitze-Multiplikator multipliziert den ganzen Stich, also auch den Anteil des PARTNERS — Steigung Fe+Bl 136 gegen Fe allein 57 (2,4×). Owner-Rahmen dazu wörtlich: „das Ziel sind eh Mischbilds, also passt wenn Feuer ein guter partner ist". **Endstand (§7.75):** die drei Paare OHNE Eis liegen auf 3 % genau gleich (23,1 / 23,7 / 23,9 Mio) und schlagen alle ihren besten Einzelteil (+8 / +9 / +48 %). Offen: Eis synergiert nicht (jedes Eis-Paar ist schlechter als Eis allein) — Vermutung: Gletscher besetzen Positionen exklusiv. Methodisch trägt die ganze Reihe: der **Duell-Median** ist die Bilanzzahl (§7.62 A), und `--only cross`-Sweeps haben ab §7.68 jede Vorhersage getroffen, während zwei Kopfrechnungen davor daneben lagen. **Korrektur in dieser Runde:** §7.70 D behauptete, der Regler mache Lichtbogen und Kettenblitz tot. Nicht gedeckt — `gross-45` ist EIN Seed-Satz, §7.62 C misst Lichtbogen VOR dem Regler schon mit +3 % auf Satz 101, und Lichtbogen zahlt `critPerStack` (Crit-Chance), eine Achse, die der Score-Regler nicht anfasst. Marker steht an beiden Stellen. |
| 2026-09-11 | Textrunde über alle 70 Skills (Owner: „kein fluff, keine bindestriche, kompakt und gut lesbar in deutsch"). **Zuerst die Wächterlage gemessen statt geraten:** sechs lange Texte probeweise gekürzt und die Suite laufen lassen — grün, nur `npm run loc:export` fehlte. Ergebnis der Aufnahme: **48 der 70 Skills tragen keine Textzusicherung, 22 werden wörtlich zitiert** (skills.test.js, fire-rework, plant-rework, skill-doors); die Zitate sind meist zahlgetrieben (`toContain(`+${T.x[0].y}...`)`) und damit die Naht Text↔Wert, kein Hindernis. **Geändert wurden sieben**, jeder mit einem benennbaren Defekt statt nach Geschmack: Ionenfeld (Floskel „lädt das Feld:", 91 → 64), Spannungsfeld („Ein Sieg in einer Formation … je Formation an der Siegposition" sagt dasselbe zweimal, 83 → 64), Schmelzpunkt (schrieb die Glossar-Definition von **Überlauf** aus, statt den Begriff zu benutzen — 114 → 67, und der Begriff wird jetzt automatisch gefettet; dazu ein falsches Komma auf Episch), Brandschneise (Namens-Echo „schlagen eine Schneise:", 143 → 100), Sonnenkern (Klammer zu Prosa, „statt sich zu erneuern" war mit „stapeln sich" schon gesagt, 207 → 193), Eiswall („gerade Kette … (Reihe oder Spalte)" → „Reihe oder Spalte", 186 → 168), Baumreihe (Semikolon-Splice und Satzstummel zu drei sauberen Sätzen). **Bewusst NICHT angefasst**, und das ist der interessantere Teil: Zündspannung (148 Zeichen, aber `skill-doors` hält die Satzform per Regex fest, und „Gewinnst du mit einer Karte" ist genauer als jede Kürzung — Crit fällt nur bei Sieg), Blitzschlag (die Klammer „(+2 Stapel)" trägt die Unterscheidung zu Streuung, die ohne Zahl 1 Stapel heißt), Eisbeben („bebt das Eis nach" ist kein Schmuck: Episch referenziert das „Nachbeben" mechanisch), Ewiges Schild und Sonnenzorn (lang, aber jeder Satz trägt eine Regel), Ranken und Verdichtung (dito). **Neuer Wächter:** kein Strich als SATZZEICHEN in Skill- und Glossartexten, unterschieden über die Leerzeichen — Bis-Striche („Werte 1–10", „Stufe I–IV", „0–100 %") bleiben erlaubt und sind im Glossar die Mehrheit. Meine erste Fassung der Regel hätte genau diese sechs Bis-Striche als Fehler gemeldet; das Zeichen allein taugt nicht als Kriterium. Gegengeprobt, indem ein Gedankenstrich in Ionenfeld gesetzt wurde: fällt mit allen vier Stufen. Gates alle grün. |
| 2026-09-12 | Schneetreiben gebufft (Owner: „Schneetreiben braucht einen Buff im Vergleich zu Dauerfrost … der eine gibt bedingungslos auf alle Felder, der andere nur auf wenige bei Gletschersieg; der mit der Bedingung braucht einen größeren Payoff"), Owner-Vorgabe **keine Messungen**. **Der Vergleich geht ohne Sim, weil beide in dieselbe Kasse zahlen:** Schnee landet in der Boden-Reserve, und `FIRN_DRAW = Infinity` zieht die je Durchlauf KOMPLETT in Gletschermasse ab (der Abstand verteilt nur, welcher Gletscher wie viel bekommt, die Menge kommt vollständig an). Also ist Schnee je Durchlauf die gemeinsame Währung, und die ist aus der Brettgeometrie 8×5 abzählbar. **Befund: Dauerfrost lieferte das 3- bis 13-fache** (6 Gletscher verteilt: 34/68/68/102 gegen 7/11/14/36). Zwei strukturelle Gründe, warum eine reine Zahlenerhöhung das nicht löst: **(1) Schneetreiben verstopft im Cluster** — es braucht einen offenen 4-Nachbarn, und bei zwölf geballten Gletschern haben nur FÜNF von zwölf einen; der Skill stirbt also genau in dem Bau, für den Verzahnung, Eiswall, Gletschersturz und die Kaskade alle bauen. **(2) Dauerfrosts `far`-Band ist auf einem verteilten Brett tot** — ab vier verteilten Gletschern liegt kein einziges Feld weiter als Chebyshev 2, die höhere der beiden Zahlen zahlt also nur im Cluster, genau umgekehrt zur Intuition, und der Kartentext sagt es nicht (nicht behoben, Befund). Umgesetzt: Saat **2/3/4/5 → 8/12/16/20**, Felder unverändert 1/1/1/2, dazu der **Rückfall in `driftTargets`**: kein offener 4-Nachbar → das nächstgelegene offene Feld (Chebyshev, bei Gleichstand kleinerer Index), und zwar NUR bei null offenen Nachbarn, kein Auffüllen eines teilweise verbauten Kranzes — sonst stimmten die vorgelegten Zahlen nicht mehr. **Die Folge ist kein Gleichstand, sondern eine Kreuzung bei rund 8 Gletschern:** Dauerfrost schrumpft mit jedem Gletscher (weniger offene Felder), Schneetreiben wächst mit jedem. Verhältnis Schneetreiben zu Dauerfrost: 4 Gletscher 0,3–0,9× · 6 Gletscher 0,5–1,4× · 8 Gletscher 0,7–1,9× · 12 Gletscher 1,2–3,4×. Damit sind die beiden nicht mehr derselbe Skill in zwei Stärken: Dauerfrost ist der dünne frühe Bau, Schneetreiben der dichte späte. **Offen und dem Owner vorgelegt:** Episch bei 12 Gletschern steht bei 3,4×; der Griff dagegen wäre das zweite Feld auf Episch (1/1/1/1) statt der Zahl, das drückt die Spitze auf rund 1,7×. **Wächter-Vorfall, wert festgehalten zu werden:** `glacier-firn` hatte einen Test „Schneetreiben sät nichts, wenn alle Nachbarn Gletscher sind (kein Firn unter Eis)" — der Titel nannte die Zusicherung #386 (kein Firn UNTER Eis), geprüft wurde aber „gar kein Firn", eine bloße FOLGE der alten Regel. Der Rückfall ließ ihn fallen. Nicht aufgeweicht, sondern auf das gezogen, was der Titel sagt: unter keinem Gletscher liegt Firn, und der Rückfall trifft wirklich ein offenes Feld. Dazu drei neue Wächter in `ice-rework` (Rückfall trifft die Diagonale; mit offenem Nachbarn greift er NICHT; der Sieg sät wirklich), alle gegengeprobt durch Entfernen des Rückfalls: die zwei, die ihn meinen, fallen, der dritte bleibt grün. Alles GERECHNET aus der Geometrie, nichts gemessen — Siegquote 60 % stammt aus der vorhandenen Messung §7.70. |
| 2026-09-12 | Packeis gebufft (Owner: „Packeis ist damit im direkten Vergleich auch zu schwach … ja so bauen mit Eisbrücken-Kopplung, dann rentiert der Skill"), wieder ohne Sim gerechnet. **Befund: Packeis war das Schlusslicht der vier Eis-Einkommen**, bei 6 Gletschern verteilt 10/15/20/30 gegen Dauerfrost 34/68/68/102, Schneetreiben 29/43/58/144 und Verzahnung 1/2/2/4; im Cluster mit 3/5/6/9 praktisch tot. **Die Ursache war ein DECKEL, den nur Packeis hatte:** ein Gletscher grenzt an höchstens vier Felder, sein Einkommen stand also bei zwölf geballten Gletschern auf demselben Wert wie bei sechs, während Verzahnung quadratisch mit dem Cluster wächst und Dauerfrost mit dem ganzen Brett. Umgesetzt deshalb **Reichweite statt Satz**: die Stufenleiter 0,5/0,75/1/1,5 bleibt unangetastet, gezählt wird jetzt im **Umkreis 2** (Chebyshev, dieselbe Bandgrenze, die Dauerfrost schon liest), **mit Eisbrücke Umkreis 3**. Die Eisbrücke-Kopplung ist ausdrücklich mitgebaut worden, weil ein Umkreis 2 die Diagonalen ohnehin enthält und die alte Kopplung (4 → 8 Nachbarn, also Verdopplung) sonst ersatzlos verfallen wäre; sie sitzt als `icePackeisRadius` neben `iceNeighborFn` in `factions/ice.js`, die Radien als `PACKEIS_RADIUS`/`PACKEIS_RADIUS_BRIDGE` in `glacier.js` (envNum, also später sweepbar). Ergebnis: Packeis liegt überall im Band und ist genau dort das Stärkste, wo es hingehört, auf dem weit verteilten Brett (12 verteilt: 66/99/132/198 gegen Dauerfrost 28/56/56/84). Die drei Einkommen haben damit getrennte Rollen: **Dauerfrost das ganze Brett, Verzahnung die Dichte, Packeis die Weite.** **Wächter:** „voll umschlossen zahlt gar nichts" war die alte Zusicherung und ist AUFGEHOBEN — genau darin bestand der Deckel. Die Umkehr aus §5.31 (dicht = weniger) wird weiter gehalten, aber als Verhältnis statt als Null; dazu ein Wächter auf die Radien selbst und auf `icePackeisRadius`. **Balance-Guard neu zentriert, mit Beleg:** Seeds 1..40 Median 10,99M und Mean 22,68M, Seeds 1..200 11,54M / 23,11M — dasselbe Niveau, also kein Ausreißer. Median-Band 5,0–10,5 → 7,0–15,0, Mean-Band 11,0–24,0 → 15,0–31,0 (der Mean stand noch INNERHALB des alten Bandes, aber mit 6 % Luft, und wurde deshalb mit zentriert statt beim nächsten Griff auf Verdacht). **Der Befund aus §7.72 B wiederholt sich damit ein zweites Mal:** ein Eis-Buff hebt den ZUFALLSSPIELER überproportional (7,77 → 10,99 Mio, +41 %), weil Gletscher unabhängig vom Rest des Builds zahlen. Beide Eis-Buffs dieses Tages stecken in der Zahl und sind nicht getrennt. |
| 2026-09-12 | `BURST_SCALE` 80 → 60 (Owner: „burst_scale runter auf 60. Messung lassen wir"). Anlass: die zwei Eis-Buffs desselben Tages haben den Zufallsspieler um 41 % gehoben, und der Regler ist der eine Griff, der die ganze Fraktion gleichmäßig senkt, statt einen frisch reparierten Skill wieder totzuschneiden — die Lehre aus §7.66, hier zum ersten Mal von Anfang an angewendet statt nach zwei Fehlversuchen. Genau dafür stand die Reserve, die §7.72 sich mit „80 statt 100, damit der Playtest in beide Richtungen tarieren kann" offengehalten hat. **Der Balance-Guard hält ohne erneutes Zentrieren:** Median 10,99 → 9,83 Mio, Mean 22,68 → 18,99 Mio, beide im gerade erst neu gesetzten Band (7,0–15,0 / 15,0–31,0). Der Regler nimmt damit gut die Hälfte dessen zurück, was Schneetreiben und Packeis zusammen gebracht haben. Kein spieler-sichtbarer Text bewegt sich: die Eis-Texte nennen die Wucht relativ (Eiswall „+15 % stärker", Eiszeit „+200 % Wucht"), nie die Konstante selbst — `loc:export` liefert entsprechend keinen Diff. **UNGEMESSEN in der neuen Kombination:** der Sweep im Konstanten-Kommentar (20/40/60/100 → Eis 6,4/10,2/13,9/21,7 Mio) lief in §7.71, also VOR beiden Buffs; er sagt, was der Regler für sich tut, nicht was er nach ihnen tut. Die einzige Zahl aus dieser Runde ist der Zufallsspieler oben, und der ist ein Nebenprodukt des Gates, keine Messreihe. |
| 2026-09-14 | Vier Anzeige-Defekte aus der Owner-Runde, alle nach demselben Muster: **der Motor rechnet eine Zahl, die Anzeige rechnet sie ein zweites Mal — und die zweite Fassung ist stehen geblieben.** (1) **Gebäude-Segmentgrenzen.** Der Pfeiler (`crossSeg`) öffnet die Segmentgrenze seiner Zeile, `canExtendSeg` liest ihn seit dem Architekt; die Anzeige kannte nur Segmentarbeit und Spalier, also fehlte die Brücke im Kartengitter. `openBorderInfo` nimmt jetzt den (schon gegatterten) Architekten als sechstes Argument und meldet die Herkunft je Grenze (`spalier` / `arch`); Aufstellphase und Chronik reichen ihn herein, der Tooltip nennt die Quelle, die Intro-Zeile zählt die Pfeiler-Grenzen. Die Grenznummer ist dieselbe wie die Zeilennummer (`rowOf(p)` = `Math.floor(k/SEGMENT_SIZE)` bei SEGMENT_SIZE 5 und 5 Spalten); die letzte Zeile hat keine Grenze hinter sich und fällt heraus. (2) **Glühende Klinge auf der Weißglut-Leiste.** Der Deckel aus §7.32 (die Klinge liest `HEAT_MAX`, nie die verlängerte Leiste) stand nur im Motor. Die Hitzeleiste rechnete ihr Abzeichen selbst und zog ihre Schwellenstriche bis ans Leistenende, mit Weißglut also bis 200 — sie versprach vier Stufen, die es nicht gibt. Zwei neue Funktionen in `factions/fire.js`, `klingeValue` und `klingeTicks`, sind jetzt die eine Quelle für Motor und Leiste. **Nebenbefund mitkorrigiert:** der Tooltip sagte weiter „ohne Deckel" — seit §7.32 falsch. (3) **Berst-Schwelle im Gletscher-Panel.** Der Chip hatte `BURST_AT` fest verdrahtet und rief „bricht", während ein Gletscher mit Abbruchkante noch bis 60 weiterwuchs. `iceBurstAt(roles, roleTiers)` liest dieselbe Naht wie `precomputeGlacier` (`iceSnapshotOpts(...).burstAt`); das Panel bekommt `glacierRoleTiers` durchgereicht, „kritisch" hängt jetzt an 75 % der wirksamen Schwelle statt an der festen 9, die Sprosse der Schwelle ist in der Segmentleiste markiert, und eine verschobene Schwelle steht als eigener Chip da, nicht nur im Tooltip. Dass die Abbruchkanten-Werte AUF den Sprossen liegen (§5.32), ist dafür Voraussetzung und wird mitgeprüft. (4) **Sortierung.** Aufwerten (Skills und Perks) und Verkauf kamen in Pick- bzw. Objekt-Reihenfolge. Jetzt aufsteigend nach Preis — weil der Preis allein an der gehaltenen Stufe hängt, ist das zugleich „nach Rarität": billigste Aufwertung oben, „höchste Stufe" ans Ende (`upgradeSortKey` in `coins.js`, von beiden Bildschirmen gelesen); im Verkauf kleinster Erlös oben, Legendäre zu 50 unten, Gesperrte zuletzt (in `sellables`, also prüfbar statt im JSX). Der Schlüssel hängt bewusst NICHT am Kontostand, sonst sprängen die Zeilen nach jedem Kauf. **Alle fünf neuen Wächter gegengeprobt, indem die jeweilige Naht absichtlich zurückgebaut wurde — alle fünf fallen, keiner davon tautologisch.** Keine Balance-Zahl bewegt sich; Gates grün, `loc:export` gelaufen (drei geänderte de-Texte). |
| 2026-09-14 | Zwei Preis-Entscheide des Owners: **Fokus rufen 5 → 10** und **Formations-Schritt 8 → 10** („Formationen sollen erst ab 10 und nicht 8 schon eine Münze geben"). Beide sind `envNum`-Konstanten in `coins.js`, die UI liest sie über `FOCUS_PRICE` bzw. `coinsForFormations` — kein Zahlen-Literal in einem Katalogtext, `loc:export` liefert entsprechend keinen Diff. Wirkung: der gemessene Median von 18 Formationen zahlt **3 statt 4** Münzen je Durchlauf, der Ruf kostet damit über drei Durchlauf-Einnahmen statt einer knappen. **Nebenwirkung, die der Owner nicht bestellt hat und die deshalb hier steht statt still korrigiert zu werden: der Münz-Deckel ist faktisch tot.** `COIN_FORM_CAP` 4 band mit Schritt 8 ab 32 Formationen und traf 1 % der gemessenen Durchläufe; mit Schritt 10 bindet er erst ab 50 und liegt damit über dem gemessenen Extremfall von 48 distinkten Formationen (§2.5 der Münz-Doku: 160 Positions×Formations-Paare bei mittlerer Länge 3,3). Die Lücke, die er schließen sollte — viele kurze Formationen bauen und den Formations-Multiplikator opfern —, steht damit wieder offen; der Griff dagegen wäre `COIN_FORM_CAP` 4 → 3, nicht der Schritt. Owner-Entscheid offen, **ungemessen**. Der Wächter „der Deckel bindet" hätte das verschluckt: er prüfte 48 gegen den Deckelwert, und 48 zahlt mit Schritt 10 zufällig genau denselben Betrag. Er rechnet jetzt aus `COIN_FORM_PER × (COIN_FORM_CAP + 1)`, also aus der ersten Zahl, bei der wirklich geschnitten wird. Drei weitere Wächter trugen die alten Beträge als Vertrag und wurden auf die neuen gezogen (Median-Auszahlung, Kontostand-Summe, Fokus-Preis) — kein aufgeweichter Wächter, nur nachgeführte Owner-Zahlen. Die Münz-Doku ist Protokoll, kein offener Plan; sie bekommt deshalb an §2.2 und §3.3 je einen `GEÄNDERT`-Marker statt umgeschriebener Plan-Zahlen. **Balance-Guard hält ohne Zentrieren**, Gates alle grün. Was die zwei Preise über den ganzen Lauf ausmachen, ist NICHT gemessen. |
| 2026-09-14 | Balance-Pass über die 41 Architekten-Gebäude (Owner: „anker, Segmentgrenzen ist viel wertvoller … wir buffen nur auf das Niveau, keine Nerfs", Band „zwischen Pfeiler und Anker", Anker bleibt Spitze). **Zuerst der Befund, warum Anker und Pfeiler überragen — und er ist strukturell, nicht numerisch:** der Architekt zahlt über drei Kanäle, und nur einer davon multipliziert. Ein Score-Flat addiert auf eine Siegbasis von 400, ein Kampfwert kippt einen Stich, ein Formations-Effekt multipliziert den GANZEN Stich und wächst damit mit allem anderen mit. Der Grundstein legt auf jede seiner Zellen einen Anker, und ein Anker IST eine Formation — auf einer Position mit schon einer Formation springt der Überlappungszähler 1→2, also ×1,5, bevor sein eigener Faktor ×1,10 überhaupt zählt. Gemessen (Münz-Doku §2.5, 81.600 Positionen) tragen 40,6 % der Positionen genau eine Formation und 33,4 % zwei, der Anker trifft also fast immer eine Sprosse: wirksam **×1,51 auf Stufe I bis ×2,04 auf IV**, gegen ×1,10/×1,49 auf der Karte. **Währung für den Vergleich:** Basis-Score je BEZAHLTER Zelle und Durchlauf — das Baufeld ist auf `MAX_COVER` gedeckelt, die Zelle ist die knappe Ressource, und alles nach `scoreBase` multipliziert Flats und Faktoren gleichermaßen. Ergebnis vorher: Grundstein 249, Pfeiler 185, Score-Mittelfeld 21–124, und am Boden die drei `target`-Gebäude mit 45–74, weil sie **vier Zellen bezahlen und eine benutzen**. **Zwei Decken, die der Entwurf erst sichtbar gemacht hat:** (1) das Tragwerk kann 180 je Zelle nicht überschreiten, weil ein Stich nur einmal kippbar ist (Kipp-Wahrscheinlichkeit exakt aus dem Raster 1–10, beide Decks tragen dasselbe `buildDeck()`); (2) Buntglas kommt mit Zahlen NIE ins Band, weil sein Farbtor (25 %) die Decke auf 45 drückt — offen, Owner-Entscheid. Umgesetzt: 33 Basiswerte, `target` legt jetzt den vollen Betrag auf die Zielkarte und die HÄLFTE auf die übrigen Zellen (bewusst nicht den vollen Betrag — sonst wären Firstträger und Sockel der Quader mit anderer Form), Wert-Leitern der fünf Formations-Hebel von 0/1/1/2 auf 1/3/4/6, Kathedrale ×1,4 → ×2,0, Schatzkammer ×1,3 → ×1,9. Alle Stufenzahlen enden ab 10 auf 0 oder 5 (Owner: „schwierig für Spieler, mit 112 zu rechnen"), gerundet in `tierNum` — der einen Funktion, die jede Stufenzahl erzeugt, Katalog und DB-Seite ziehen mit; die Monotonie bleibt die stärkere Regel. Kein bestehender Wert wurde gesenkt (mechanisch abgeklemmt statt je Zeile geprüft); Wetthalle und Spielbank lagen mit der Owner-Crit-Vorgabe von vornherein ÜBER dem Band und blieben unangetastet. **Der wichtigste Eintrag ist ein Fehlschlag:** der erste Wurf der Wert-Leitern (1/3/5/7) riss den Mean von 18,99 auf 32,31M — über EINEN Lauf, Seed 34 von 23M auf 443M, während der Median sich kaum bewegte. Mein Entwurfsmodell hatte die Leiter unterschätzt, weil es einen gekippten Stich mit der Siegbasis 400 bewertet; diese Gebäude sitzen aber auf den formationsdichten Feldern, wo ein Stich ein Vielfaches wert ist. Der Sweep legt die Kante scharf zwischen IV=6 (Mean 21,14M, max 147M) und IV=7 (Mean 32,31M, max 443M). Mit 1/3/4/6 halten **beide Bänder ohne Anpassung** — der Guard musste entgegen der Erwartung gar nicht neu zentriert werden. Vier neue bzw. umgeschriebene Wächter, alle gegengeprobt. **Ungemessen:** Crit-Quote (Owner-Vorgabe: reines Blitzbuild erreicht ab Runde 30 rund 100 %, tariert wurde auf eine Referenz von 50 % und die Bandoberkante), Serienlänge, Nachbarzahl, vollendete Strukturen. Vorlage-Seite: /code/artifact/e40dd68a. |
| 2026-09-14 | Nachtrag zum Architekt-Pass: die drei Tor-Gebäude (Owner: „a" — Tore lockern). **Zuerst eine Korrektur an meiner eigenen Vorlage, weil sie die Optionen falsch dargestellt hat:** ich hatte die drei Tore als ZUFALL gerechnet, zwei davon sind aber Spielerentscheidungen. Der **Wehrgang** deckt die vier Ecken eines 3×3 (`grundstueck`); liegt er in den oberen zwei Zeilen, sind alle vier Zellen in der frühen Hälfte — sein Tor ist offen, sobald man ihn richtig setzt, und er stand nie bei 78, sondern bei ~156. Die **Rampe** zählt Karten bis Wert 5–8, bei einem gleichverteilten Deck 1–10 also 50–80 % und kein Viertel. Nur **Buntglas** trug ein echtes Tor: 1 von 4 Farben, und um es zu steuern muss man Aufstell-Energie verbrennen, die man für Formationen braucht. Umgesetzt wurde deshalb ein kleinerer Eingriff als angeboten: Buntglas bekommt einen `tierKick` auf III, ab dem die Farbbedingung fällt (dieselbe Bauart wie Arkades farbJoker-Kick — Stufe I/II behalten Tor und Identität, III/IV zahlen frei und erreichen die Wert-Decke von 180); die Rampe rückt eine Schwelle weiter (≤6…≤9). Der Wehrgang blieb unangetastet. **Zwei Kartentexte logen dabei und sind mitkorrigiert:** Buntglas III las sich als „passende Farbe +7 Stichwert · die Farbbedingung fällt weg" und widersprach sich damit selbst (der Satz wird jetzt der flache, sobald der Kick zündet), und die Rampe nannte ihre Schwelle überhaupt nicht — sie stand nur im Code, also hätte der Spieler die Änderung nie gesehen. `rampThresholdFor` ist dafür exportiert, Motor und Text lesen dieselbe Quelle. Zwei neue Wächter halten beides am Verhalten fest, nicht an der Zahl. Endstand Seeds 1..40: **Median 9,22M, Mean 20,44M, größter Lauf 147M** — beide Bänder halten weiter ohne Anpassung, und der Schwanz ist unverändert. |
| 2026-09-14 | Kopfleiste des Architekten neu gebaut (Owner: „gebaude bonus ist abgeschnitten“ → Mockup → „c, zweizeilig“). **Der Defekt war ein Flex-Row, in dem nur EINE Kachel schrumpfen durfte.** Boost, Baufeld und Durchlauf-Score standen nebeneinander, aber nur die Boost-Kachel trug `flex-1 min-w-0`; die beiden rechten hielten ihre natürliche Breite, und in der mittleren saß der Kauf-Knopf, der wegen Preis, Münzsymbol und Vorrats-Punkten nicht schmaler wird. Der gesamte Platzdruck landete damit auf der einen Kachel, die nachgeben durfte: auf dem Telefon brach erst die Beschriftung um, dann riss das Prozentzeichen von der Zahl ab. **Jetzt ein Raster statt eines Flex-Rows** — schmal zwei Spalten (Boost | Baufeld) mit dem Durchlauf-Score als flacher Zeile darunter, ab `sm` wieder drei Spalten; `sm:grid-cols-3` wird nur gesetzt, wenn es einen Durchlauf-Score gibt, sonst stünde dort eine leere dritte Spalte. Jede Zahl und jede Beschriftung trägt `whitespace-nowrap`, damit die Einheit bei ihrer Zahl bleibt. **Der Kauf-Knopf ist aus der Kachel heraus in eine eigene Leiste gezogen** (neuer Schlüssel `arch.plot.buyStrip`): er ist eine Handlung, keine Kennzahl, und er war der einzige Grund, warum eine der drei Kacheln nicht passen konnte. Gemessen im laufenden Spiel (Playwright, Dev-Run bis in die Architekt-Phase): bei **375 px und 320 px** sind alle vier Beschriftungen und die Boost-Zahl einzeilig (gemessene Höhe = Zeilenhöhe). Der Querscroll, der bei 320 px bleibt, gehört **nicht** hierher — die Sonde weist ihn der Laufkopfzeile und der Statusleiste zu (`rn-head`, `rn-bar`, `as-statusbar`); kein Element der Kopfleiste ragt über den Rand. Nicht angefasst: der breite Abstand zwischen Zahl und Prozentzeichen kommt von `tabular-nums` (das Leerzeichen erhält Ziffernbreite) und bestand vorher genauso. |
| 2026-09-14 | Legendäre Skills tragen in der Build-Übersicht einen Goldrahmen (Owner: „legendäre skills sollen in diesem Panel auch einen goldenen Rahmen haben“). Die Chips der `SkillList` färbten sich allein nach Fraktion — Ewige Glut sah dort aus wie Glutbett, obwohl die Perk-Zeile direkt darüber ihre Legendären längst in Gold markiert. Jetzt trägt der RAHMEN die Seltenheit und die SCHRIFT weiter die Fraktion: zwei Angaben, zwei Träger, und der Fraktions-Blick auf die Zeile bleibt erhalten. Deckkraft `88` wie bei den Perk-Chips darüber, damit beide Zeilen dieselbe Marke tragen. **Nebenbefund beim Bauen, und der eigentliche Fund:** das Gold der Legendär-Marke stand als Literal `#e0b845` an VIER Stellen (einmal `HeldSkills`, dreimal `SkillSelect` — Badge in der Ersetzen-Liste, Badge in der Angebotskarte, Kantenfarbe der Angebotskarte); die Build-Übersicht wäre die fünfte geworden. Es gibt jetzt eine Konstante `LEGENDARY_GOLD` in `HeldSkills.jsx`, wo auch `skillTierColor` und `SkillTierBadge` schon wohnen — keine eigene Datei für einen Wert, und kein fünfter `TIER_META`-Eintrag, weil Legendäre außerhalb der Stufenleiter stehen (`rarity.js`). **Der Wächter prüft das gerenderte Markup, nicht den Quelltext:** `renderToStaticMarkup` auf die echte `SkillList`, dann die Farbe im `outline` des legendären Chips gegen die eines normalen Skills DERSELBEN Fraktion — eine Quelltext-Ratsche auf `LEGENDARY_GOLD` hielte auch dann, wenn die Konstante an der falschen Stelle steht. Gegenprobe gefahren, beide Richtungen: Rahmen auf die Fraktionsfarbe zurückgedreht → zwei Erwartungen fallen; `leg` negiert (legendär und normal vertauscht) → dieselben zwei fallen. Die dritte Erwartung (keine zweite Abschrift des Golds) hat sich beim ersten Lauf selbst bewiesen — sie hat die zwei `SkillSelect`-Kopien gefunden, die ich beim Suchen übersehen hatte. Nicht angefasst: das Detail-Feld unter den Chips (öffnet sich beim Klick) behält seinen Fraktionsrahmen; und das Gold der Perk-Chips ist ein anderer Ton (`#d4a63a` aus `RARITY_META`) — nebeneinander gerendert ist der Unterschied auf Chip-Größe nicht zu sehen, zusammenlegen wäre ein eigener Entscheid. |
| 2026-09-14 | Ein Gold für „legendär“ (Owner: „gold zusammenlegen und einheitlich machen“). **Die Bestandsaufnahme zuerst, weil sie den Zuschnitt entschieden hat:** im Quelltext stehen 33 Hex-Werte im Goldbereich, aber sie meinen nicht dasselbe — Deck-Themen, Partikel-Effekte, Schmiede-Gold, die Gelb-Farbe, ein Warnton, und vor allem die Score-/Rekord-Akzente, die zufällig denselben Wert tragen wie das Perk-Gold. Zusammengelegt wurde deshalb **nur die Seltenheitsstufe**, und die trug tatsächlich drei Töne: Perks `#d4a63a`, Skills `#e0b845`, Gebäude `#c8962f`. Am sichtbarsten auf der legendären Skill-Karte, die den animierten Ring aus `.as-legendary` (`#d4a63a`) und ihre eigene Kante (`#e0b845`) einen Pixel nebeneinander stellte — dort standen zwei Golds in einem Bauteil. Kanonisch ist `#d4a63a`: den Wert tragen `--ac-gold` (index.css) und `RARITY_META.legendary.color` (game/perks.js) schon, er war nie strittig, nur nie durchgesetzt. Die Konstante `LEGENDARY_GOLD` wohnt in `ui/indicators/vocab.js` (dem bestehenden Farb-Vokabular, aus dem Architekt, Karten und Brett ohnehin lesen), zwölf Anzeigeflächen lesen sie. **Sichtbar ändert sich damit zweierlei:** legendäre Gebäude werden etwas heller, legendäre Skills etwas tiefer. **Der Wächter (`test/legendary-gold.test.js`) hat drei Schichten, und die erste allein hielte nichts:** (1) die drei Deklarationen desselben Werts stimmen überein; (2) kein Hex-Literal im Goldbereich steht in einer Zeile, die „legendary/legendär“ nennt — Grau- und Fraktionsfarben im Nicht-Legendär-Zweig eines Ternärs bleiben erlaubt, ein zweites Gold nicht; (3) die zwölf Seltenheits-Oberflächen importieren die Konstante, was die Lücke von (2) schließt: eine Zeile wie `leg ? … : c` trägt das Wort gar nicht. Der Farbton wird gerechnet (Hue 33–58°, satt und hell genug), nicht gegen eine Liste bekannter Werte geprüft — sonst fiele nur der Rückfall auf, nicht die Erfindung. Kommentare werden vor der Suche entfernt, sonst schlüge der Wächter auf der Erklärung an, die ihn begründet (die alten Töne stehen in `vocab.js` als Prosa). Gegenprobe dreifach gefahren: alter Ton zurück → (2) und (3) fallen; ein NEUES, nie dagewesenes Gold → (2) fällt; CSS-Token verstellt → (1) fällt. **Nicht angefasst und bewusst:** die rund 80 `#d4a63a` der Score-/Rekord-Akzente. Gleicher Wert, andere Bedeutung — sie unter den Namen „legendär“ zu ziehen wäre derselbe Fehler an einer neuen Stelle. Keine Quelltext-Ratsche ist gerissen, alle Gates grün. |
| 2026-09-14 | §7.68 Der Lichtbogen wird der Kaltstart von Blitz (Owner: „lichtbogen muss angepasst werde, er gibt kriegt für ladung, aber ladung hat man erst wenn man crit hat“ → Richtung a). **Die Diagnose am Code bestätigt, und schärfer als gemeldet:** `chargeGainOnWin()` ist die EINZIGE Ladungsquelle der Fraktion, sie zahlt nur bei SIEG und nur bei CRIT — die einzige Ausnahme im ganzen Zweig war `noCritCharge: 1`, eine Zeile auf Blitzableiter EPISCH. Der Lichtbogen las die Stapel der gespielten Karte, Stapel entstehen aus vollen Leisten, Leisten aus Crits: er saß am Ende seiner eigenen Schleife. **Gerechnet** (Leiste 10, 40 Stiche, Siegquote 55 %, nur das Passiv als Crit-Quelle): bei 17 % Crit (3 Blitz-Skills) 3,7 Crits je Durchlauf, also **2,5 Durchläufe bis zum ersten Stapel im ganzen Deck** — Lichtbogen Normal gab darauf 0,5 % × 1/40 ≈ 0,0125 % Crit-Chance. Oben, ab rund 100 % Crit (Owner-Annahme für ein reines Blitzbuild ab Runde 30), ist die Chance-Achse geklemmt. Kein Fenster. **Jetzt liest er den einzigen Eingang, den niemand bediente:** Siege OHNE Crit, Takt 4./3./2./jeder, Betrag überall +1; Episch verdoppelt bis zum ersten Crit eines Durchlaufs. Leisten je Durchlauf bei 17 % Crit: 0,37 → **0,83 / 0,98 / 1,29 / 2,20**; bei 100 % Crit geben alle vier Stufen **exakt null** — der Skill baut sich am eigenen Erfolg ab, ohne eigene Regel. Blitzableiter gibt die Zeile ab und bekommt dafür +2 statt +1 Ladung je Takt-Crit auf Episch, dieselbe Achse. **Eine Falle dabei, die den Ersatz entschieden hat:** der naheliegende Griff wäre `back` 2 → 3 gewesen. Reststrom Episch setzt Boden 6 bei Leiste 9 — mit `back: 3` wäre die Leiste nach JEDEM Leeren sofort wieder voll gewesen, eine Leiste je Sieg ohne Ende. Ein Wächter hält den Abstand jetzt fest, egal an welcher der beiden Zahlen später jemand dreht. **Gegenprobe an fünf Nähten gefahren, und die fünfte hat eine echte Lücke aufgedeckt:** Lichtbogen zahlt auf einem Crit → fällt; der Verdoppler hört nie auf → fällt; Blitzableiter bekommt die Zeile zurück → fällt; `back: 3` → fällt; **Durchlauf-Reset der Crit-Marke entfernt → blieb GRÜN.** Ohne ihn wäre Episch nur leiser gewesen (Marke hält den ganzen Lauf statt des Durchlaufs) und niemand hätte es gesehen. Dafür steht jetzt ein Wächter am letzten Stich des Durchlaufs. **Nebeneffekt, beabsichtigt:** die Crit-Chance-Achse fällt von vier Skills auf drei. Sie war überbesetzt und sättigt gemeinsam bei 100 %. **Nicht gemessen, auf Owner-Ansage** („bau so, keine Messung“) — und der Umfang ist größer als der Skill: Ladung ist der Eingang der ganzen Fraktion, Kettenblitz, Streuung, Ionenfeld, Gewitterfront, Entladung und Reststrom hängen alle an Leisten. Die Balance-Bänder sind unangetastet und ungeprüft. Alle Gates grün. |
| 2026-09-14 | §7.69 Potenzial — der 15. Blitz-Skill (Owner: „Potenzial klingt gut“). **Anlass war eine Zählung:** Eis und Pflanze führen 15 normale Skills, Blitz und Feuer nur 14. Beide sind durch Streichungen dorthin gefallen und nie aufgefüllt worden (Blitz: §7.18 legte Statische Aufladung und Dauerstrom zusammen, §7.19 strich den Überschlag; Feuer: §7.16 strich den Flächenbrand). Die Owner-Untergrenze aus §7.19 war 14, eingehalten — aber gleichauf waren sie nie. **Die Lücke, die er füllt, kam aus dem §7.68-Bau:** `chargeGainOnWin` zahlt nur bei einem SIEG, die Siegquote drosselt damit die ganze Fraktion — und dafür arbeiteten bisher nur Blitzfänger und Ionenfeld, beide hinter der Ionisierung, also hinter Leisten, also hinter Siegen. Dasselbe Henne-Ei, das §7.68 gerade aus dem Lichtbogen entfernt hat. Potenzial macht die **Ladung selbst** zum Kampfwert (je 5/4/3/2 Ladung +1 Wert) und hängt damit an nichts. Der Sägezahn ist die Bauart: kurz vor dem Einschlag am stärksten, direkt danach bei null, kein Deckel nötig. **Gerechnet** aus der Kartenverteilung (beide Decks 4 × 1..10, Leistenstand gleichverteilt angenommen): der Anteil verlorener Stiche, der kippt, liegt bei **4,5 / 7,0 / 10,2 / 16,0 %**; bei 18 Niederlagen je Durchlauf sind das +0,8 / +1,3 / +1,8 / +2,9 Siege, Siegquote 55 % → 57 / 58 / 60 / 62 %. Ehrlich dazu: das ist eine Rückkopplung (mehr Siege → mehr Ladung → mehr Wert), sie bricht aber bei jedem Einschlag zusammen. **Kein Episch-Extra** — die vier Stufentexte trennt der Teiler, und die Leiter spreizt schon um Faktor 3,5; der Owner hatte die Entscheidung offen gelassen, der Vorschlag lautete ohne. **Platz und Emblem ohne neue Grafik:** der Skill sitzt auf `SK_LIGHTNING_08` (gestrichene Statische Aufladung), das Emblem ist deren Master, umbenannt und mit `scripts/skill-art-build.py` in die Auslieferung gerechnet (384 px, Bloom gebacken) — dieselbe Bauart wie die 83 anderen. **Nebenbefund, offen:** `docs/art/skills/` trägt die Master noch unter den Namen GESTRICHENER Skills (Glut, Feuerwalze, Überspannung, Ionisierung, Breitenbeschleuniger, Serienschutz …). Wer das Projekt-Skript heute wie dokumentiert aufruft, erzeugt rund 20 Dateien mit toten Namen neben der richtigen Auslieferung. Ich habe deshalb nur die eine Datei übernommen und den Rest verworfen; das Aufräumen der Master ist eine eigene Runde. **Gegenprobe an vier Nähten:** Engine-Verdrahtung entfernt → fällt; auf- statt abgerundet → fällt; liest Leisten statt Ladung (der alte Lichtbogen-Fehler in neuer Kleidung) → fällt; Leiter gedreht → fällt. **Nicht gemessen, auf Owner-Ansage.** Alle Gates grün, 206 Datenbank-Einträge. Blitz führt damit 15 normale Skills; **Feuer steht weiter bei 14.** |
| 2026-09-14 | §7.70 Feuer: Brandherd als 15. Skill, und Glutbetts zweite Hälfte neu (Owner: „brandherd mit Formation klingt gut, 2/3/4 Leiter ist fein“ und „glutbett ist gut, aber der zweite Teil der Mechanik ist zu stark“). **Der Befund, der den Skill begründet, ist gerechnet:** die Hitze steigt nur bei Vorsprung ≥ 3 um (Vorsprung − 1) % und fällt bei jeder Niederlage flach um 6 %. Aus der Kartenverteilung (beide Decks 4 × 1..10) ergibt das eine **Drift von −2,18 % je Stich bei 45 % Siegquote, −1,14 % bei 55 %, und erst bei rund 64 % dreht sie ins Plus.** Darunter steht die Leiste bei null — und damit stehen sechs Feuer-Skills still, die auf 80 bis 100 % Hitze warten (Feuersturm, Schmelzpunkt, Brandmal, Lauffeuer, Schmiede, Weißglut). Repariert haben das bisher nur Zunder und Glutbett, zwei gewöhnliche Angebote: wer keines zieht, spielt eine Fraktion, deren Motor nicht anspringt. Feuer hat seinen Kaltstart verloren, als §7.23 die Glut strich und den Platz an die Feuerlinie gab — die ist ein Auszahler, kein Starter. **Brandherd** (`SK_FIRE_10`, Platz des gestrichenen Funkenflugs) koppelt die Hitze vom unsichtbaren Vorsprung ab und an die AUFSTELLUNG: +2/3/4/5 % je zahlender Formation an der Siegposition, ohne Schwelle, ohne Hitze-Tor. Bei 1,5 zahlenden Formationen je Position (§7.58 gemessen 1,4–1,7) und 55 % Siegquote: Drift +0,51 / +1,34 / +2,16 / +2,99, also **4,9 / 1,9 / 1,2 / 0,8 Durchläufe bis zur vollen Leiste**. Feuerlinie liest dieselbe Eingabe, zahlt sie aber in Score statt in Hitze — ein Paar, keine Dopplung. **Glutbett:** der steigende Boden aus §6.24 ist weg. Simuliert über 50 Durchläufe endeten **alle vier Stufen bei Boden 100 und Hitze 100**, bei 45 % wie bei 55 % Siegquote; die Stufe entschied nur, wie schnell (Normal 60 Abfänge, Sehr selten 7). Nach dem Lauf war Normal gleich Episch — die Rarität war wertlos, genau wie der Owner es gemeldet hat. Nach seinem Vorschlag („über dem Schwellenwert Niederlagen um einen Kampfwert weniger weh tun“) mildert der Boden jetzt die KÜHLUNG statt zu wachsen, und zwar oberhalb der Schwelle, wo er vorher nichts tat: 5/4/3 statt 6 %, Episch unverändert ohne Kühlung. Endhitze damit **40 / 61 / 82 / 100 bei 45 %** und 56 / 75 / 90 / 100 bei 55 %, also ×1,20 / 1,30 / 1,40 / 1,50. **Ehrlich zur Kühlungs-Leiter:** sie trägt wenig — gegen ein flaches „immer 5" unterscheidet sie sich in genau einer Zelle. Der BODEN macht die Stufen; gestaffelt ist sie, damit beide Sätze der Karte eine Stufe tragen. **Gegenprobe an sechs Nähten:** formCount nicht durchgereicht → fällt; Brandherd liest den Vorsprung statt der Formationen → fällt; Glutbett kühlt wieder flach 6 → fällt; der steigende Boden kommt zurück → fällt; Brandherd-Leiter gedreht → **blieb zuerst GRÜN**, wie schon beim Lichtbogen in §7.68, dafür steht jetzt ein Monotonie-Wächter; Kühlungs-Leiter flach gemacht → fällt. **Emblem ohne neue Grafik:** der Master des Funkenflugs, umbenannt und mit `scripts/skill-art-build.py` gerechnet. Der Nebenbefund aus §7.69 bleibt offen — das Skript erzeugt aus den Mastern rund 20 Dateien mit Namen gestrichener Skills; übernommen wurde wieder nur die eine. **Nicht gemessen, auf Owner-Ansage.** Alle Gates grün, 207 Datenbank-Einträge. Damit führen alle vier Fraktionen 15 normale Skills. |
