...
| Q16 | **Eis + Pflanze lessons follow the fire redesign** | The eis and pflanze sections get the same compact rebuild as feuer (Q13 pattern: few slim pages, one visual per page, Skill/Passiv chips, engine numbers). To be co-designed as artifacts in a later step ("die wir jetzt noch nachziehen"). |
