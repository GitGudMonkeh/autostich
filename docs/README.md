...
| `marketing-brief.md` | **live** | 2026-09-09 | Project overview for outward-facing work: game logic, design fundamentals, genre classification, competitors and positioning. Written as the single knowledge base for a later marketing agent; declares itself neither player-visible nor an agent prompt. Derived from the code at a named SHA and carries a source-of-truth map |
